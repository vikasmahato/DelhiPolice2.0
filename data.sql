...
--
-- Host: localhost:3306
-- Generation Time: Apr 09, 2017 at 11:05 PM
...
CREATE TABLE `emg_list` (
  ...
  `death_legal_certificate` tinyint(2) DEFAULT NULL,
...
CREATE TABLE `form` (
  ...
  `police_station_no` varchar(25) DEFAULT NULL,
  `si_no` varchar(10) DEFAULT NULL,
  `diary_no` varchar(8) DEFAULT NULL,
  `ref_hospital_name` varchar(100) DEFAULT NULL,
  `a_cghs_no` int(7) DEFAULT NULL,
  `a_cghs_exp` varchar(20) DEFAULT NULL,
  `r_cghs_no` int(7) DEFAULT NULL,
  `r_cghs_exp` varchar(20) DEFAULT NULL,
  `a_cghs_category` varchar(13) DEFAULT NULL,
  ...
  `status` enum('NULL','D_HAND','HAG','I_ADMIN','ACP','PHQ','DCP','FAILED','APPROVED','REEVAL_IADMIN','REEVAL_HAG','REEVAL_ACP','REEVAL_DCP') DEFAULT NULL,
  `period` varchar(15) NOT NULL DEFAULT '0',
  `claim_type` enum('IP_REFERRAL','IP_EMERGENCY','OP_REFERRAL','OP_EMERGENCY','CREDIT','PERMISSION','ADV_CLAIM') NOT NULL,
  `hospType` char(7) NOT NULL DEFAULT 'NULL',
  `phq_memo` varchar(10) DEFAULT NULL,
  `phq_memo_date` varchar(20) DEFAULT NULL,
  `amt_due` int(6) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `form` (`app_id`, `applicant_name`, `pis`, `rank`, `relation`, `relative_name`, `pincode`, `startdate`, `enddate`, `hospital_name`, `hospital_address`, `police_station_no`, `si_no`, `diary_no`, `ref_hospital_name`, `a_cghs_no`, `a_cghs_exp`, `r_cghs_no`, `r_cghs_exp`, `a_cghs_category`, `disease`, `application_date`, `diary_date`, `amt_asked`, `amt_granted`, `amt_available`, `status`, `period`, `claim_type`, `hospType`, `phq_memo`, `phq_memo_date`, `amt_due`) VALUES
(53, 'Vikram Singh', '28030759', 'Head Constable', 'Mother', '', 0, '2017-02-15', '2099-01-01', 'Batra Hospital & Medical Research Centre', '1, Tughlakabad Institutional Area, MB Road, New Delhi.', '1424/SE', NULL, '1596', 'NULL', 3539378, '2017-08-31', 3539382, '2017-08-31', 'General', '', NULL, '2017-02-16', 0.00, 0.00, NULL, 'HAG', '29905', 'CREDIT', 'NULL', NULL, NULL, 0),
(54, 'Lalit Mohan', '28941092', 'Head Constable', 'own', '', 0, '2017-02-08', '2099-01-01', 'Malik Radix Health Care', 'C-218, Nirman Vihar, Vikas Marg, New Delhi-110092', '736/SE', NULL, '1611', 'NULL', 129642, '2020-07-31', 0, '2099-01-01', 'General', '', NULL, '2017-02-16', 0.00, 0.00, NULL, 'HAG', '29912', 'CREDIT', 'NULL', NULL, NULL, 0),
(55, 'Devender Singh', '28871526', 'Assistant Sub-Inspector of Police', 'Father ', '', 0, '2017-02-16', '2099-01-01', 'Metro Hospitals & Heart Institute ', 'X-1, Sec-12, Noida', '730/SE', NULL, '1613', 'NULL', 230504, '2019-04-30', 230508, '2019-04-30', 'General', '', NULL, '2017-02-16', 0.00, 0.00, NULL, 'HAG', '29904', 'CREDIT', 'NULL', NULL, NULL, 0),
(60, 'Shri Kant Dhama', '28031728', 'Constable', 'Wife', '', 0, '2016-12-12', '2016-12-24', 'Yashoda Super Speciality Hospital', 'kaushambi, Ghaziabad', '4261/SE', NULL, '1006', 'CGHS Dispensary', 3233991, '2017-06-30', 3653748, '2017-06-30', 'General', '', '2017-02-17', '2017-02-03', 15311.00, 9800.00, NULL, 'HAG', '12', 'OP_REFERRAL', 'NULL', NULL, NULL, 0),
(63, 'Styabir Singh', '28920145', 'Constable', 'own', '', 0, '2017-02-26', '2099-01-01', 'Metro Heart Institute With Multispecialty ', 'Sector-16A, Faridabad ', '1431/SE', NULL, '1959', 'NULL', 3676718, '2017-02-28', 0, '2099-01-01', 'General', '', '2017-02-27', '2017-02-27', 0.00, 419.00, NULL, 'HAG', '29894', 'CREDIT', 'NULL', NULL, NULL, 0),
(64, 'Pawan Kumar Yadav', '28060975', 'Constable', 'Father ', '', 0, '2017-02-25', '2099-01-01', 'Moolchand Medicity Hospital ', 'Lajpat Nagar-III, New Delhi-110024', '3243/SE', NULL, '1928', 'NULL', 3844403, '2017-10-31', 4537339, '2020-06-30', 'General', '', '2017-02-27', '2017-02-27', 0.00, 328.00, NULL, 'HAG', '29895', 'CREDIT', 'NULL', NULL, NULL, 0),
(65, 'Virender Singh', '28821659', 'Assistant Sub-Inspector', 'Mother', '', 0, '2017-02-21', '2099-01-01', 'Guru Teg Bahadur Hospital', 'Preet Vihar, Delhi', '411/SE', NULL, '1958', 'Sharp Sight Centre', 140579, '2019-07-31', 140585, '2021-11-30', 'General', '', '2017-02-27', '2017-02-27', 0.00, 328.00, NULL, 'HAG', '29899', 'PERMISSION', 'NULL', NULL, NULL, 0),
(68, 'Kuldeep Singh Nagar', '28030356', 'Head Constable', 'Father', '', 0, '2016-11-29', '2016-12-20', 'Safdarjang Hospital', 'New Delhi-110029', '322/SE', NULL, '1725', 'Focus Imaging', 3464866, '2042-11-30', 3464873, '2042-11-30', 'General', '', '2017-02-27', '2017-02-21', 570.00, 570.00, NULL, 'HAG', '21', 'OP_REFERRAL', 'NULL', NULL, NULL, 0),
(69, 'Hari Chand ', '29102324', 'Constable', 'wife', '', 0, '2017-02-22', '2099-01-01', 'CGHS Dispensary ', 'Sec-16, Faridabad', '3569/SE', NULL, '1970', 'Metro Hospital ', 3898998, '2017-11-30', 4153132, '2018-10-31', 'General', '', '2017-02-28', '2017-02-28', 0.00, 0.00, NULL, 'HAG', '29898', 'PERMISSION', 'NULL', NULL, NULL, 0),
(70, 'Sandeep Sharma', '28103333', 'Constable', 'wife ', '', 0, '2017-02-27', '2099-01-01', 'Park Hospital ', 'Faridabad (Haryana)', '1252/SE', NULL, '2006', 'NULL', 3795224, '2048-08-31', 3795225, '2048-08-31', 'General', '', '2017-02-28', '2017-02-28', 0.00, 0.00, NULL, 'HAG', '29893', 'CREDIT', 'NULL', NULL, NULL, 0),
(71, 'Amit Kumar', '28093236', 'Constable', 'father', '', 0, '2017-02-25', '2099-01-01', 'CGHS Dispensary ', 'Vasant Kunj, New Delhi', '3858/SE', NULL, '2015', 'ILBS Hospital ', 3921413, '2017-12-31', 3921423, '2017-12-31', 'General', '', '2017-02-28', '2017-02-28', 0.00, 0.00, NULL, 'HAG', '29895', 'PERMISSION', 'NULL', NULL, NULL, 0),
(72, 'Rakesh Kumar', '28081144', 'Constable', 'own', '', 0, '2017-02-28', '2099-01-01', 'National Heart Institute ', '49-50, Community Centre, New Delhi', '1621/SE', NULL, '2022', 'NULL', 3527531, '2022-02-28', 0, '2099-01-01', 'General', '', '2017-02-28', '2017-02-28', 0.00, 0.00, NULL, 'HAG', '29892', 'CREDIT', 'NULL', NULL, NULL, 0),
(74, 'Dinesh Kumar', '27970175', 'Assistant Sub-Inspector', 'own', '', 0, '2017-01-19', '2017-01-22', 'Bansal  ', 'hosp', '65/SE', NULL, '2013', 'refHospName', 258281, '2035-08-31', 0, '2099-01-01', 'General', 'Fever with chills ', '2017-02-28', '2017-02-28', 16920.00, 16920.00, NULL, 'HAG', '3', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(76, 'Bir Bal Singh ', '28821402', 'Assistant Sub-Inspector', 'wife ', '', 0, '2017-03-01', '2099-01-01', 'Safdarjung Hospital', 'Lajpat Nagar-IV, NewDelhi', '2722/SE', NULL, '1830', 'Eye-7 Hospital ', 132050, '2020-08-31', 132053, '2020-08-31', 'General', 'NULL', '2017-03-02', '2017-03-01', 0.00, 0.00, NULL, 'HAG', '29891', 'PERMISSION', 'NULL', NULL, NULL, 0),
(77, 'Birendra Singh ', '28861751', 'Assistant Sub-Inspector', 'wife ', '', 0, '2017-03-01', '2099-01-01', 'Bansal Hospital', 'A-1, New Friends Colony, New Delhi', '2561/SE', NULL, '2078', 'NULL', 2060781, '2026-12-31', 2060782, '2026-12-31', 'General', 'NULL', '2017-03-02', '2017-03-02', 0.00, 0.00, NULL, 'HAG', '29891', 'CREDIT', 'NULL', NULL, NULL, 0),
(78, 'Manish Kumar', '28104813', 'Constable', 'own', '', 0, '2017-03-02', '2099-01-01', 'CGHS Dispensary ', 'New Delhi', '995/SE', NULL, '2076', 'Rockland Hospital ', 3461375, '2021-08-31', 0, '2099-01-01', 'General', 'NULL', '2017-03-02', '2017-03-02', 0.00, 0.00, NULL, 'HAG', '29890', 'PERMISSION', 'NULL', NULL, NULL, 0),
(79, 'Om Parkash', '28883794', 'Assistant Sub-Inspector', 'own', '', 0, '2017-03-03', '2099-01-01', 'Metro Hospital & Heart Institute ', 'H-Block, Palam Vihar, Gaurgaon', '3460/SE', NULL, '2149', 'NULL', 162821, '2020-06-30', 0, '2099-01-01', 'General', 'NULL', '2017-03-06', '2017-03-06', 0.00, 0.00, NULL, 'HAG', '29889', 'CREDIT', 'NULL', NULL, NULL, 0),
(80, 'Amit Sagar', '28081694', 'Constable', 'wife', '', 0, '2017-03-04', '2099-01-01', 'QRG Central Hospital & Research Centre', 'Sector-20A, Near Neelam Flyover, Faridabad', '886/SE', NULL, '2148', 'NULL', 4216920, '2018-11-30', 4216929, '2018-11-30', 'General', 'NULL', '2017-03-06', '2017-03-06', 0.00, 0.00, NULL, 'HAG', '29888', 'CREDIT', 'NULL', NULL, NULL, 0),
(81, 'Niraj Kumar', '28031801', 'Constable', 'mother', '', 0, '2017-03-06', '2099-01-01', 'Kailash Hospital Ltd.', '23, Institutional Area, Greater Noida', '1997/SE', NULL, '2317', 'NULL', 3321466, '2020-07-31', 3321475, '2020-07-31', 'General', 'NULL', '2017-03-08', '2017-03-08', 0.00, 0.00, NULL, 'HAG', '29886', 'CREDIT', 'NULL', NULL, NULL, 0),
(82, 'Anand Kumar Jha', '16090035', 'Sub-Inspector', 'mother', '', 0, '2017-03-06', '2099-01-01', 'Batra Hospital & Medical Research Centre', 'MB Road, New Delhi', 'D/4646', NULL, '2321', 'NULL', 4332932, '2019-04-30', 4332937, '2019-04-30', 'General', 'NULL', '2017-03-08', '2017-03-08', 0.00, 0.00, NULL, 'HAG', '29886', 'CREDIT', 'NULL', NULL, NULL, 0),
(83, 'Anand Kumar Jha', '16090035', 'Sub-Inspector', 'father', '', 0, '2017-03-06', '2099-01-01', 'Batra Hospital & Medical Research Centre', 'MB Road, New Delhi', 'D/4646', NULL, '2322', 'NULL', 4332932, '2019-04-30', 4332935, '2019-04-30', 'General', 'NULL', '2017-03-08', '2017-03-08', 0.00, 0.00, NULL, 'HAG', '29886', 'CREDIT', 'NULL', NULL, NULL, 0),
(84, 'Prabhakar Mishra', '28080622', 'Constable', 'father', '', 0, '2017-03-10', '2099-01-01', 'Tirath Ram Shah Hospital', 'Isher Das Sawhney Marg, Rajpur Road, Delhi', '3200/SE', NULL, '2400', 'NULL', 3497798, '2046-09-30', 3497801, '2046-09-30', 'General', 'NULL', '2017-03-10', '2017-03-10', 0.00, 0.00, NULL, 'HAG', '29882', 'CREDIT', 'NULL', NULL, NULL, 0),
(85, 'Kamini', '28140941', 'Constable', 'father', '', 0, '2017-03-06', '2099-01-01', 'National Heart Institute ', '49-50, Community Centre, East of Kailash, New Delhi-110065', '4013/SE', NULL, '2398', 'NULL', 4906308, '2021-08-31', 4906319, '2021-08-31', 'General', 'NULL', '2017-03-10', '2017-03-10', 0.00, 0.00, NULL, 'HAG', '29886', 'CREDIT', 'NULL', NULL, NULL, 0),
(86, 'Arun Kumar Pandey', '28950111', 'Head Constable', 'own', '', 0, '2017-03-06', '2099-01-01', 'Deepak Memorial Hospital', 'Vikash Marg New Delhi', '2948/SE', NULL, '2402', 'NULL', 277306, '2019-05-31', 0, '2099-01-01', 'General', 'NULL', '2017-03-10', '2017-03-10', 0.00, 0.00, NULL, 'HAG', '29886', 'CREDIT', 'NULL', NULL, NULL, 0),
(87, 'Siddharth Kelkar', '28011649', 'Head Constable', 'son', '', 0, '2017-03-09', '2099-01-01', 'Mata Chanan Devi Hospital', 'C-1, Nanak Puri, New Delhi', '134/SE', NULL, '2410', 'NULL', 243054, '2021-01-31', 4851457, '2021-01-30', 'General', 'NULL', '2017-03-10', '2017-03-10', 0.00, 0.00, NULL, 'HAG', '29883', 'CREDIT', 'NULL', NULL, NULL, 0),
(88, 'Niraj Kumar', '28031801', 'Constable', 'father', '', 0, '2017-03-11', '2099-01-01', 'CGHS Dispensary ', '23-KPI, Greater Noida', '1997/SE', NULL, '2545', 'Kailash Hospital ', 3321466, '2020-07-31', 3321471, '2020-07-31', 'General', 'NULL', '2017-03-14', '2017-03-14', 0.00, 0.00, NULL, 'HAG', '29881', 'PERMISSION', 'NULL', NULL, NULL, 0),
(89, 'Pawan Kumar', '28840974', 'Assistant Sub-Inspector', 'own', '', 0, '2017-01-02', '2017-01-06', 'Metro Hospital & Heart Institute ', 'hosp', '383/SE', NULL, '2198', 'refHospName', 150427, '2020-06-30', 0, '2099-01-01', 'General', 'chest discomfort', '2017-03-14', '2017-03-06', 22033.00, 22033.00, NULL, 'HAG', '4', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(90, 'Raj Kumar ', '28882337', 'Assistant Sub-Inspector', 'mother ', '', 0, '2017-01-14', '2017-01-19', 'Surbhi Hospital ', 'hosp', '210/SE', NULL, '984', 'refHospName', 178908, '2021-08-31', 178915, '2018-11-30', 'General', 'fever with chills ', '2017-03-14', '2017-02-02', 40568.00, 40568.00, NULL, 'HAG', '5', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(92, 'dummy', '1245', 'Constable', 'own', '', 0, '2017-03-15', '2017-03-18', 'Aiims', 'NULL', '12345/se', NULL, '12354', 'NULL', 123456789, '2019-05-01', 0, '2099-01-01', 'General', 'NULL', '2017-03-14', '2017-05-01', 256.00, 150.00, NULL, 'HAG', '3', 'OP_REFERRAL', 'NULL', NULL, NULL, 0),
(93, 'Raj Kumar', '28871707', 'Assistant Sub-Inspector', 'own', '', 0, '2017-03-10', '2099-01-01', 'CGHS Dispensary ', 'Railway Road, Gurgaon', '3467/SE', NULL, '2411', 'Ahooja Eye & Dental Institute ', 275227, '2021-11-30', 0, '2099-01-01', 'General', 'NULL', '2017-03-14', '2017-03-10', 0.00, 0.00, NULL, 'HAG', '29882', 'PERMISSION', 'NULL', NULL, NULL, 0),
(94, 'Smiriti', '12345', 'W/Constable', 'own', '', 0, '2016-02-02', '2099-01-01', 'AIima', 'd-082hsdas', '123/SE', NULL, '12312', 'max', 13456789, '2039-02-02', 0, '2099-01-01', 'Private', 'NULL', '2017-03-14', '2016-02-02', 0.00, 0.00, NULL, 'HAG', '30284', 'PERMISSION', 'NULL', NULL, NULL, 0),
(95, 'Raj Kumar ', '28882337', 'Assistant Sub-Inspector', 'mother', '', 0, '2017-01-14', '2017-01-19', 'Surbhi Hospital ', 'hosp', '210/SE', NULL, '984', 'refHospName', 178908, '2021-08-31', 178915, '2018-11-30', 'General', 'fever with chills ', '2017-03-15', '2017-02-02', 29080.00, 29080.00, NULL, 'HAG', '5', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(96, 'Ram Gopal ', '28960943', 'Assistant Sub-Inspector', 'own', '', 0, '2017-02-22', '2017-02-23', 'QRG Central Hospital ', 'hosp', '492/SE', NULL, '2369', 'refHospName', 3491669, '2020-07-31', 0, '2099-01-01', 'General', 'Heavy bleeding ', '2017-03-15', '2017-03-09', 29080.00, 29080.00, NULL, 'HAG', '1', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(97, 'Omi', '94860006', 'MTS', 'own', '', 0, '2017-01-07', '2017-01-14', 'Metro Hospital & Heart Institute ', 'hosp', '117/S', NULL, '2409', 'refHospName', 5260171, '2019-01-31', 0, '2099-01-01', 'General', 'Chest pain ', '2017-03-15', '2017-03-10', 170903.00, 170793.00, NULL, 'HAG', '7', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(98, 'Raj Kumar', '28882337', 'Assistant Sub-Inspector', 'mother', '', 0, '2016-12-27', '2017-01-05', 'Surbhi Hospital ', 'hosp', '210/SE', NULL, '658', 'refHospName', 178908, '2021-08-31', 178915, '2018-11-30', 'General', 'Fever with chills ', '2017-03-15', '2017-01-19', 59785.00, 59785.00, NULL, 'HAG', '9', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(99, 'Rahul Yadav ', '28081504', 'Constable', 'wife ', '', 0, '2017-02-11', '2017-02-15', 'Bhagat Chandra Hospital ', 'hosp', '2986/SE', NULL, '2370', 'refHospName', 3562421, '2046-12-31', 3562424, '2046-12-31', 'General', '38 week pregnancy ', '2017-03-15', '2017-03-09', 36652.00, 36652.00, NULL, 'HAG', '4', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(100, 'Premvir Singh', '28883387', 'Head Constable', 'Father', '', 0, '2017-03-14', '2099-01-01', 'Sunil Hospital', 'Malviya Nagar New Delhi', '1058/SE', NULL, '2596', 'NULL', 214191, '2021-08-31', 214196, '2021-08-31', 'General', 'NULL', '2017-03-15', '2017-03-15', 0.00, 0.00, NULL, 'HAG', '29878', 'CREDIT', 'NULL', NULL, NULL, 0),
(101, 'Vikas Solanki ', '28061403', 'Head Constable', 'wife', '', 0, '2017-03-14', '2099-01-01', 'Narinder Mohan Hospital', 'Mohan Nagar, Ghaziabad', '3298/SE', NULL, '2604', 'NULL', 4440796, '2019-09-30', 4440797, '2019-09-30', 'General', 'NULL', '2017-03-15', '2017-03-15', 0.00, 0.00, NULL, 'HAG', '29878', 'CREDIT', 'NULL', NULL, NULL, 0),
(102, 'Sandeep Bhati', '28106038', 'Constable', 'Mother', '', 0, '2017-03-16', '2099-01-01', 'Yatharth Wellness Hospital & Heart Centre', 'Sec-110 Noida (Uttar Pradesh)', '1632/SE', NULL, '2630', 'NULL', 5053036, '2021-08-31', 5053105, '2021-08-31', 'General', 'NULL', '2017-03-16', '2017-03-16', 0.00, 0.00, NULL, 'HAG', '29876', 'CREDIT', 'NULL', NULL, NULL, 0),
(103, 'Nobat Singh', '28801314', 'Assistant Sub-Inspector', 'own', '', 0, '2017-03-16', '2099-01-01', 'Bansal Hospital', 'A-1, New Friends Colony, New Delhi-110025', '661/SE', NULL, '2628', 'NULL', 3952460, '2018-07-31', 0, '2099-01-01', 'General', 'NULL', '2017-03-16', '2017-03-16', 0.00, 0.00, NULL, 'HAG', '29876', 'CREDIT', 'NULL', NULL, NULL, 0),
(104, 'Manoj Kumar Meena ', '28030967', 'Head Constable', 'Father', '', 0, '2017-03-15', '2099-01-01', 'Mata Chanan Devi Hospital', 'C-1, Janak Puri, new Delhi-58', '2191/SE', NULL, '2631', 'NULL', 228299, '2021-10-31', 228301, '2021-10-31', 'General', 'NULL', '2017-03-16', '2017-03-16', 0.00, 0.00, NULL, 'HAG', '29877', 'CREDIT', 'NULL', NULL, NULL, 0),
(105, 'Shiv Ram', '28911827', 'Head Constable', 'Wife', '', 0, '2017-03-15', '2099-01-01', 'Bansal Hospital', 'A-1, New Friends Colony, New Delhi-110025', '1703/SE', NULL, '2629', 'NULL', 4386521, '2019-06-30', 4386523, '2019-06-30', 'General', 'NULL', '2017-03-16', '2017-03-16', 0.00, 0.00, NULL, 'HAG', '29877', 'CREDIT', 'NULL', NULL, NULL, 0),
(106, 'Hari Ram', '28910549', 'Assistant Sub-Inspector', 'Wife', '', 0, '2017-03-15', '2099-01-01', 'Park Hospital Multi Super Speciality Hospital', 'Sec-10, Faridabad', '1748/SE', NULL, '2632', 'NULL', 3911875, '2017-11-30', 3911879, '2017-11-30', 'General', 'NULL', '2017-03-16', '2017-03-16', 0.00, 0.00, NULL, 'HAG', '29877', 'CREDIT', 'NULL', NULL, NULL, 0),
(107, 'Bharat Singh', '28850484', 'Sub-Inspector', 'own', '', 0, '2017-02-24', '2099-01-01', 'Institute of Liver & Biliary Sciences ', 'D-1, Vasant Kunj, New Delhi', 'D/1326', NULL, '2634', 'NULL', 204976, '2019-05-31', 0, '2099-01-01', 'Semi-Private', 'NULL', '2017-03-16', '2017-03-16', 0.00, 0.00, NULL, 'HAG', '29896', 'CREDIT', 'NULL', NULL, NULL, 0),
(108, 'Amit Kumar', '28110234', 'Constable', 'mother', '', 0, '2017-03-15', '2099-01-01', 'Bansal Hospital ', 'A-1, New Friends Colony, New Delhi', '3689/SE', NULL, '2635', 'NULL', 3938845, '2018-01-31', 3938846, '2018-01-31', 'General', 'NULL', '2017-03-16', '2017-03-16', 0.00, 0.00, NULL, 'HAG', '29877', 'CREDIT', 'NULL', NULL, NULL, 0),
(109, 'Tejender Singh', '28911206', 'Assistant Sub-Inspector', 'father', '', 0, '2017-03-18', '2099-01-01', 'Moolchand Medcity Hospital ', 'Lajpat Nagar-III, New Delhi', '466/SE', NULL, '2721', 'NULL', 176995, '2019-04-30', 177000, '2019-04-30', 'General', 'NULL', '2017-03-20', '2017-03-20', 0.00, 0.00, NULL, 'HAG', '29874', 'CREDIT', 'NULL', NULL, NULL, 0),
(110, 'Harveer Meena', '28107078', 'Constable', 'own', '', 0, '2017-03-19', '2099-01-01', 'Bansal Hospital ', 'A-1, New Friends Colony, New Delhi', '3283/SE', NULL, '2678', 'NULL', 3834949, '2017-08-31', 0, '2099-01-01', 'General', 'NULL', '2017-03-20', '2017-03-20', 0.00, 0.00, NULL, 'HAG', '29873', 'CREDIT', 'NULL', NULL, NULL, 0),
(111, 'Lokesh Kumar', '28101464', 'Constable', 'mother', '', 0, '2017-03-17', '2099-01-01', 'CGHS Dispensary ', 'Faridabad', '2436/SE', NULL, '2679', 'Fortis Escort Hospital ', 4508302, '2020-06-30', 4710039, '2020-07-31', 'General', 'NULL', '2017-03-20', '2017-03-20', 0.00, 0.00, NULL, 'HAG', '29875', 'PERMISSION', 'NULL', NULL, NULL, 0),
(112, 'Om Parkash ', '28883794', 'Assistant Sub-Inspector', 'own', '', 0, '2017-03-10', '2099-01-01', 'CGHS Dispensary ', 'H-Block, Palam Vihar, Gurgaon', '3460/SE', NULL, '2680', 'Metro Hospital & Heart Institute ', 162821, '2020-06-30', 0, '2099-01-01', 'General', 'NULL', '2017-03-20', '2017-03-20', 0.00, 0.00, NULL, 'HAG', '29882', 'PERMISSION', 'NULL', NULL, NULL, 0),
(113, 'Vedpal Singh', '28821772', 'Assistant Sub-Inspector', 'wife', '', 0, '2017-03-18', '2099-01-01', 'Narinder Mohan Hospital ', 'Mohan Nagar, New Delhi', '477/SE', NULL, '2722', 'NULL', 3483799, '2022-02-28', 3483815, '2022-02-28', 'General', 'NULL', '2017-03-20', '2017-03-20', 0.00, 0.00, NULL, 'HAG', '29874', 'CREDIT', 'NULL', NULL, NULL, 0),
(114, 'Suman Kumari', '28102253', 'W/Constable', 'own', '', 0, '2017-03-19', '2099-01-01', 'Surbhi Hospital', 'Golf Course Road, Morna, Sector-35, Noida, U.P.', '3129/SE', NULL, '2777', 'NULL', 3822432, '2018-06-30', 0, '2099-01-01', 'General', 'NULL', '2017-03-21', '2017-03-21', 0.00, 0.00, NULL, 'HAG', '29873', 'CREDIT', 'NULL', NULL, NULL, 0),
(115, 'Nirlekh Yadav', '28107763', 'Constable', 'Father', '', 0, '2017-02-15', '2099-01-01', 'CGHS Dispenser', 'Gurgaon', '3551/SE', NULL, '2393', 'MEDANTA HOSPITAL', 3903706, '2017-11-30', 3903710, '2017-11-30', 'General', 'NULL', '2017-03-21', '2017-03-10', 0.00, 0.00, NULL, 'HAG', '29905', 'PERMISSION', 'NULL', NULL, NULL, 0),
(116, 'Ramesh Kumar ', '28901835', 'Head Constable', 'own', '', 0, '2017-03-21', '2099-01-01', 'BANSAL HOSPITAL', 'A-1, N.F.C. New Delhi', '1808/SE', NULL, '2778', 'NULL', 214578, '2017-12-31', 0, '2099-01-01', 'General', 'NULL', '2017-03-21', '2017-03-21', 0.00, 0.00, NULL, 'HAG', '29871', 'CREDIT', 'NULL', NULL, NULL, 0),
(117, 'Vishwanath ', '28881971', 'Head Constable', 'own', '', 0, '2017-03-21', '2099-01-01', 'Bansal Hospital ', 'A-1, New Friends Colony, New Delhi', '2030/SE', NULL, '2812', 'NULL', 183967, '2021-08-31', 0, '2099-01-01', 'General', 'NULL', '2017-03-22', '2017-03-22', 0.00, 0.00, NULL, 'HAG', '29871', 'CREDIT', 'NULL', NULL, NULL, 0),
(118, 'Yogesh Tanwar', '16100080', 'Sub-Inspector', 'own', '', 0, '2017-03-21', '2099-01-01', 'National Heart Institute ', '49-50, Community Centre, East of Kailash, New Delhi', 'D-5070', NULL, '2811', 'NULL', 3776539, '2017-06-30', 0, '2099-01-01', 'General', 'NULL', '2017-03-22', '2017-03-22', 0.00, 0.00, NULL, 'HAG', '29871', 'CREDIT', 'NULL', NULL, NULL, 0),
(119, 'Tulsi Ram', '28911700', 'Head Constable', 'wife', '', 0, '2017-03-22', '2099-01-01', 'QRG Central Hospital & Research Centre ', '69, Sec-20A, Faridabad ', '1670/SE', NULL, '2810', 'NULL', 245709, '2020-05-31', 245710, '2020-05-31', 'General', 'NULL', '2017-03-22', '2017-03-22', 0.00, 0.00, NULL, 'HAG', '29870', 'CREDIT', 'NULL', NULL, NULL, 0),
(120, 'Ashok Kumar', '28081732', 'Head Constable', 'own', '', 0, '2017-03-21', '2099-01-01', 'Bansal Hospital ', 'A-1, New Frinends Colony, New DElhi', '2982/SE', NULL, '2815', 'NULL', 3560898, '2020-05-31', 0, '2099-01-01', 'General', 'NULL', '2017-03-22', '2017-03-22', 0.00, 0.00, NULL, 'HAG', '29871', 'CREDIT', 'NULL', NULL, NULL, 0),
(121, 'Pawan Kumar ', '28871082', 'Assistant Sub-Inspector', 'own', '', 0, '2017-03-23', '2099-01-01', 'Metro Hospital & Heart Institute ', 'Lajpat Nagar, New Delhi', '1836/SE', NULL, '2801', 'Metro Hospital & Heart Institute ', 150222, '2020-08-31', 0, '2099-01-01', 'General', 'NULL', '2017-03-22', '2017-03-22', 0.00, 0.00, NULL, 'HAG', '29869', 'PERMISSION', 'NULL', NULL, NULL, 0),
(122, 'Manisha Kumari ', '28090913', 'W/Constable', 'own', '', 0, '2017-03-22', '2099-01-01', 'Bansal Hospital ', 'A-1, New Friends Colony, New Delhi', '3048/SE', NULL, '2814', 'NULL', 3508987, '2049-10-31', 0, '2099-01-01', 'General', 'NULL', '2017-03-22', '2017-03-22', 0.00, 0.00, NULL, 'HAG', '29870', 'CREDIT', 'NULL', NULL, NULL, 0),
(123, 'Harpal Singh', '28910674', 'Head Constable', 'wife', '', 0, '2017-03-20', '2099-01-01', 'CGHS Dispensary ', 'Ghaziabad', '3448/SE', NULL, '2800', 'Shanti Gopal Hospital ', 219541, '2017-06-30', 219542, '2017-06-30', 'General', 'NULL', '2017-03-22', '2017-03-22', 0.00, 0.00, NULL, 'HAG', '29872', 'PERMISSION', 'NULL', NULL, NULL, 0),
(124, 'Dinesh Kumar', '28930350', 'Head Constable', 'daughter ', '', 0, '2017-03-22', '2099-01-01', 'Moolchand Medcity Hospital ', 'Lajpat Nagar-III, New Delhi', '1421/SE', NULL, '2816', 'NULL', 1075049, '2021-08-31', 1075056, '2021-08-31', 'General', 'NULL', '2017-03-22', '2017-03-22', 0.00, 0.00, NULL, 'HAG', '29870', 'CREDIT', 'NULL', NULL, NULL, 0),
(125, 'Rakesh Kumar', '28081144', 'Constable', 'own', '', 0, '2017-02-28', '2017-03-04', 'National Heart Institute ', 'hosp', '1621/SE', NULL, '2622', 'refHospName', 3527531, '2022-02-28', 0, '2099-01-01', 'General', 'pain abdomen ', '2017-03-23', '2017-03-16', 35453.00, 33453.00, NULL, 'HAG', '4', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(126, 'Kamini ', '28140941', 'W/Constable', 'father ', '', 0, '2017-03-06', '2017-03-10', 'National Heart Institute ', 'hosp', '4013/SE', NULL, '2621', 'refHospName', 4906308, '2021-08-31', 4906319, '2021-08-31', 'General', 'Diabetic ', '2017-03-23', '2017-03-16', 35453.00, 33453.00, NULL, 'HAG', '4', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(127, 'Anand Kumar Jha ', '16090035', 'Sub-Inspector', 'father', '', 0, '2017-03-06', '2017-03-08', 'Batra Hospital ', 'hosp', 'D/4646', NULL, '2599', 'refHospName', 4332932, '2019-04-30', 4332935, '2019-04-30', 'General', 'Hypertension ', '2017-03-23', '2017-03-15', 11226.00, 11226.00, NULL, 'HAG', '2', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(128, 'Anand Kumar Jha ', '16090035', 'Sub-Inspector', 'mother ', '', 0, '2017-03-06', '2017-03-08', 'Batra Hospital ', 'hosp', 'D/4646', NULL, '2598', 'refHospName', 4332932, '2019-04-30', 4332937, '2019-04-30', 'General', 'severe gastrits ', '2017-03-23', '2017-03-15', 10231.00, 10231.00, NULL, 'HAG', '2', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(129, 'Ram Bilas ', '28108556', 'Constable', 'own', '', 0, '2017-02-16', '2017-02-23', 'Batra Hospital ', 'hosp', '3590/SE', NULL, '2597', 'refHospName', 3858203, '2017-09-30', 0, '2099-01-01', 'General', 'Fever', '2017-03-23', '2017-03-15', 47757.00, 0.00, NULL, NULL, '7', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(130, 'Mohd. Furkan Ali', '29101158', 'Constable', 'own', '', 0, '2017-03-21', '2099-01-01', 'Garg Hospital', '8-9, A.G.C.R Enclave (opp.Karkardooma  Courts), Delhi-110092', '3608/SED', NULL, '2859', 'NULL', 5173983, '2017-09-30', 0, '2099-01-01', 'General', 'NULL', '2017-03-23', '2017-03-23', 47757.00, 47757.00, NULL, 'HAG', '29871', 'CREDIT', 'NULL', NULL, NULL, 0),
(131, 'Ram Bilas ', '28108556', 'Constable', 'own', '', 0, '2017-02-16', '2017-02-23', 'Batra Hospital ', 'hosp', '3590/SE', NULL, '2597', 'refHospName', 3858203, '2017-09-30', 0, '2099-01-01', 'General', 'Fever', '2017-03-23', '2017-03-15', 47757.00, 47757.00, NULL, 'HAG', '7', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(132, 'Hari Chand ', '29102324', 'Constable', 'wife', '', 0, '2017-03-22', '2099-01-01', 'CGHS Dispensary ', 'New Delhi', '3569/SE', NULL, '2858', 'Holy Family Hospital ', 3898998, '2017-11-30', 4153132, '2018-10-31', 'General', 'NULL', '2017-03-23', '2017-03-23', 0.00, 0.00, NULL, 'HAG', '29870', 'PERMISSION', 'NULL', NULL, NULL, 0),
(133, 'Mukesh Kumar', '28012159', 'Head Constable', 'father', '', 0, '2017-03-20', '2099-01-01', 'Deep Chand Bandu Hospital ', 'Gurgaon ', '2823/SE', NULL, '2860', 'Paras Hospital ', 1758085, '2037-12-31', 1758088, '2037-12-31', 'General', 'NULL', '2017-03-23', '2017-03-23', 0.00, 0.00, NULL, 'HAG', '29872', 'PERMISSION', 'NULL', NULL, NULL, 0),
(134, 'Parmod Bhati ', '28950827', 'Head Constable', 'own', '', 0, '2017-03-23', '2099-01-01', 'CGHS Dispensary ', 'Greater Noida ', '1200/SE', NULL, '2885', 'Sarda Hospital ', 184432, '2020-06-30', 0, '2099-01-01', 'General', 'NULL', '2017-03-24', '2017-03-24', 0.00, 0.00, NULL, 'HAG', '29869', 'PERMISSION', 'NULL', NULL, NULL, 0),
(135, 'Parmod Bhati ', '28950827', 'Head Constable', 'wife ', '', 0, '2017-03-23', '2099-01-01', 'CGHS Dispensary ', 'Greater Kailash', '1200/SE', NULL, '2887', 'Sarda Hospital ', 184432, '2020-07-31', 184433, '2020-07-31', 'General', 'NULL', '2017-03-24', '2017-03-24', 0.00, 0.00, NULL, 'HAG', '29869', 'PERMISSION', 'NULL', NULL, NULL, 0),
(136, 'Chandan kumar', '16090070', 'Sub-Inspector', 'wife', '', 0, '2017-03-24', '2099-01-01', 'Bansal Hospital ', 'A-1, New Friends Colony, New Delhi', 'D-4695', NULL, '2909', 'NULL', 4735262, '2020-08-31', 4735283, '2020-08-31', 'General', 'NULL', '2017-03-24', '2017-03-24', 0.00, 0.00, NULL, 'HAG', '29868', 'CREDIT', 'NULL', NULL, NULL, 0),
(137, 'Sandeep Kumar', '28106038', 'Constable', 'mother', '', 0, '2017-03-22', '2099-01-01', 'Yatharth Super Speciality Hospitals ', 'Sec-110, Noida ', '1632/SE', NULL, '2904', 'NULL', 5053036, '2021-08-31', 5053105, '2021-08-31', 'General', 'NULL', '2017-03-24', '2017-03-24', 0.00, 0.00, NULL, 'HAG', '29870', 'CREDIT', 'NULL', NULL, NULL, 0),
(139, 'Naresh Kumar', '28823702', 'Assistant Sub-Inspector', 'own', '', 0, '2017-03-10', '2099-01-01', 'Safdarjung Hospital', 'M.D.Eye Care, M-Block , GK-II', '143/SE', NULL, '2923', 'M.D.Eye Care & Laser Centre', 151676, '2021-12-31', 0, '2099-01-01', 'General', 'NULL', '2017-03-25', '2017-03-25', 0.00, 0.00, NULL, 'APPROVED', '29882', 'PERMISSION', 'NULL', NULL, NULL, 0),
(140, 'Ankit Tyagi', '28122025', 'Constable', 'mother ', '', 0, '2017-03-23', '2099-01-01', 'Mata Chanan Devi Hospital ', 'C-1, Janak Puri, New Delhi', '4164/SE', NULL, '2932', 'NULL', 4548824, '2020-06-30', 4548829, '2020-06-30', 'General', 'NULL', '2017-03-27', '2017-03-27', 0.00, 0.00, NULL, 'HAG', '29869', 'CREDIT', 'NULL', NULL, NULL, 0),
(141, 'Sanoj Kumar', '28010464', 'Head Constable', 'daughter ', '', 0, '2017-03-05', '2017-03-08', 'Mata Chanan Devi Hospital ', 'hosp', '479/SE', NULL, '2875', 'refHospName', 1144088, '2020-07-31', 3175617, '2021-11-30', 'General', 'Fever', '2017-03-27', '2017-03-23', 13888.00, 13888.00, NULL, 'HAG', '3', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(142, 'Manoj Kumar Meena', '28030967', 'Head Constable', 'father ', '', 0, '2017-03-06', '2017-03-08', 'Mata Chanan Devi Hospital ', 'hosp', '2191/SE', NULL, '2876', 'refHospName', 228299, '2021-10-31', 228301, '2021-10-31', 'General', 'Breathing difficulty', '2017-03-27', '2017-03-23', 9000.00, 9000.00, NULL, 'HAG', '2', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(143, 'Niraj Kumar', '28031801', 'Constable', 'mother', '', 0, '2017-03-06', '2017-03-11', 'Kailash Hospital ', 'hosp', '1997/SE', NULL, '2878', 'refHospName', 3321466, '2020-07-31', 3321475, '2020-07-31', 'General', 'Fever', '2017-03-27', '2017-03-23', 18199.00, 18199.00, NULL, 'HAG', '5', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(144, 'Anita Kumari ', '28000414', 'W/Head Constable', 'son', '', 0, '2017-03-03', '2017-03-04', 'Mata Chanan Devi Hospital ', 'hosp', '3982/SE', NULL, '2877', 'refHospName', 5201025, '2021-11-30', 5201028, '2021-11-30', 'General', 'Tongue laceration ', '2017-03-27', '2017-03-23', 12938.00, 12938.00, NULL, 'HAG', '1', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(145, 'Pramod Kumar', '28883299', 'Assistant Sub-Inspector', 'own', '', 0, '2017-01-24', '2017-02-02', 'Moolchand Hospital ', 'hosp', '3339/SE', NULL, '2868', 'refHospName', 161677, '2020-06-30', 0, '2099-01-01', 'General', 'Hypertension ', '2017-03-27', '2017-03-23', 44211.00, 43611.00, NULL, 'HAG', '9', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(146, 'Chetan ', '28121959', 'Constable', 'father', '', 0, '2017-03-25', '2099-01-01', 'Yashoda Hospital ', 'Nehru Nagar, Ghaziabad', '4174/SE', NULL, '2977', 'NULL', 4261695, '2019-01-31', 4261697, '2019-01-31', 'General', 'NULL', '2017-03-27', '2017-03-27', 0.00, 0.00, NULL, 'HAG', '29867', 'CREDIT', 'NULL', NULL, NULL, 0),
(147, 'Mohd. Aslam ', '28902713', 'Head Constable', 'own', '', 0, '2017-03-07', '2099-01-01', 'Max Health Care', 'Saket, New Delhi ', '2884/SE', NULL, '2962', 'Max Health Care Hospital ', 214338, '2019-09-30', 0, '2099-01-01', 'General', 'NULL', '2017-03-27', '2017-03-27', 0.00, 0.00, NULL, 'HAG', '29885', 'PERMISSION', 'NULL', NULL, NULL, 0),
(148, 'Tejender Singh', '28911206', 'Assistant Sub-Inspector', 'father', '', 0, '2017-01-03', '2017-01-05', 'Moolchand Hospital ', 'hosp', '466/SE', NULL, '2879', 'refHospName', 176995, '2019-04-30', 177000, '2019-04-30', 'General', 'Hypertension ', '2017-03-27', '2017-03-23', 16364.00, 0.00, NULL, NULL, '2', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(149, 'Ashok Kumar', '28871144', 'Assistant Sub-Inspector', 'mother', '', 0, '2017-03-26', '2099-01-01', 'Bansal Hospital ', 'A-1, New Friends Colony, New Delhi', '3729/SE', NULL, '3026', 'NULL', 166967, '2021-08-31', 166973, '2021-08-31', 'General', 'NULL', '2017-03-28', '2017-03-28', 0.00, 0.00, NULL, 'HAG', '29866', 'CREDIT', 'NULL', NULL, NULL, 0),
(150, 'Sukram Pal ', '28912117', 'Head Constable', 'daughter ', '', 0, '2017-03-27', '2099-01-01', 'Panchsheel Hospital ', '64-A, Yamuna Vihar, New Delhi', '3427/SE', NULL, '3024', 'NULL', 245230, '2021-08-31', 245233, '2021-08-31', 'General', 'NULL', '2017-03-28', '2017-03-28', 0.00, 0.00, NULL, 'HAG', '29865', 'CREDIT', 'NULL', NULL, NULL, 0),
(151, 'Tejender Singh ', '28911206', 'Assistant Sub-Inspector', 'father ', '', 0, '2017-01-03', '2017-01-05', 'Moolchand Medcity Hospital ', 'hosp', '466/SE', NULL, '2879', 'refHospName', 176995, '2019-04-30', 177000, '2019-04-30', 'General', 'Hypertension ', '2017-03-28', '2017-03-23', 16364.00, 15764.00, NULL, 'HAG', '2', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(152, 'Indal Chand ', '28900480', 'Assistant Sub-Inspector', 'own', '', 0, '2017-03-27', '2099-01-01', 'Bansal Hospital ', 'A-1, New Friends Colony, New Delhi', '2280/SE', NULL, '3034', 'NULL', 119514, '2021-08-31', 0, '2099-01-01', 'General', 'NULL', '2017-03-28', '2017-03-28', 0.00, 0.00, NULL, 'HAG', '29865', 'CREDIT', 'NULL', NULL, NULL, 0),
(153, 'Dharampal ', '28780613', 'Sub-Inspector', 'own', '', 0, '2016-11-14', '2016-12-01', 'Moolchand Medcity Hospital ', 'hosp', '5041/D', NULL, '2871', 'refHospName', 259812, '2019-10-31', 0, '2099-01-01', 'Semi-Private', 'Breathlessness ', '2017-03-28', '2017-03-23', 130109.00, 129509.00, NULL, 'HAG', '17', 'IP_EMERGENCY', 'NULL', NULL, NULL, 0),
(154, 'Gulab Singh ', '28911218', 'Head Constable', 'own', '', 0, '2017-03-27', '2099-01-01', 'Bansal Hospital ', 'A-1, New Friends Colony, New Delhi', '767/SE', NULL, '3043', 'NULL', 1088362, '2021-08-31', 0, '2099-01-01', 'General', 'NULL', '2017-03-28', '2017-03-28', 0.00, 0.00, NULL, 'HAG', '29865', 'CREDIT', 'NULL', NULL, NULL, 0),
(155, 'Nemi Chand ', '28880454', 'Constable', 'son', '', 0, '2017-03-23', '2099-01-01', 'CGHS Dispensary ', 'Kalkaji, New Delhi ', '2393/SE', NULL, '3040', 'Sweta Dental Clinic ', 169959, '2020-06-30', 169961, '2020-06-30', 'General', 'NULL', '2017-03-28', '2017-03-28', 0.00, 0.00, NULL, 'HAG', '29869', 'PERMISSION', 'NULL', NULL, NULL, 0),
(156, 'Sheel Kumar', '28821535', 'Sub-Inspector', 'wife ', '', 0, '2017-03-29', '2099-01-01', 'Metro Hospital & Heart Institute  ', 'Lajpat Nagar-IV, New Delhi', '6630/D', NULL, '3141', 'NULL', 209796, '2019-10-31', 209798, '2019-10-31', 'General', 'NULL', '2017-03-29', '2017-03-29', 0.00, 0.00, NULL, 'HAG', '29863', 'CREDIT', 'NULL', NULL, NULL, 0),
(157, 'Rajiv Kumar Sirohi', '28881327', 'Head Constable', 'own', '', 0, '2017-03-22', '2099-01-01', 'CGHS Dispensary ', 'Faridabad, Haryana', '3669/SE', NULL, '3134', 'Fortis Escort Hospital ', 262775, '2020-06-30', 0, '2099-01-01', 'General', 'NULL', '2017-03-29', '2017-03-29', 0.00, 0.00, NULL, 'HAG', '29870', 'PERMISSION', 'NULL', NULL, NULL, 0),
(158, 'Anil Kumar', '28980929', 'Constable', 'own', '', 0, '2017-03-28', '2099-01-01', 'Sunder Lal Jain Hospital ', 'Ashok Vihar, Phase-II, Delhi ', '2478/SE', NULL, '3152', 'NULL', 156538, '2021-08-31', 0, '2099-01-01', 'General', 'NULL', '2017-03-29', '2017-03-29', 0.00, 0.00, NULL, 'HAG', '29864', 'CREDIT', 'NULL', NULL, NULL, 0),
(159, 'Surender Pal Singh ', '28982031', 'Head Constable', 'own', '', 0, '2017-03-27', '2099-01-01', 'CGHS Dispensary ', 'Ghaziabad, UP', '1876/SE', NULL, '3145', 'Yashoda Hospital ', 152600, '2021-02-28', 0, '2099-01-01', 'General', 'NULL', '2017-03-29', '2017-03-29', 0.00, 0.00, NULL, 'HAG', '29865', 'PERMISSION', 'NULL', NULL, NULL, 0),
(160, 'Manesh Singh ', '28108635', 'Constable', 'mother', '', 0, '2017-03-28', '2099-01-01', 'Park Hospital  ', 'Faridabad ', '1700/SE', NULL, '3153', 'NULL', 4157524, '2018-10-31', 4157528, '2018-10-31', 'General', 'NULL', '2017-03-29', '2017-03-29', 0.00, 0.00, NULL, 'HAG', '29864', 'CREDIT', 'NULL', NULL, NULL, 0),
(161, 'Giriraj Singh', '28910254', 'Head Constable', 'wife', '', 0, '2017-03-25', '2099-01-01', 'SJH Hospital ', 'Okhla Road, New Delhi', '1480/SE', NULL, '3193', 'Fortis Escort Hospital ', 2891923, '2021-08-31', 2891926, '2021-08-31', 'General', 'NULL', '2017-03-30', '2017-03-30', 0.00, 0.00, NULL, 'HAG', '29867', 'PERMISSION', 'NULL', NULL, NULL, 0),
(162, 'Lakhpat Singh', '28893007', 'Head Constable', 'wife', '', 0, '2017-03-29', '2099-01-01', 'Batra Hospital & Medical Research Centre ', 'M.B.Road, New Delhi', '3175/SE', NULL, '3192', 'NULL', 258871, '2019-01-31', 258872, '2019-01-31', 'General', 'NULL', '2017-03-30', '2017-03-30', 0.00, 0.00, NULL, 'HAG', '29863', 'CREDIT', 'NULL', NULL, NULL, 0),
(163, 'Pawan kumar', '27130166', 'Head Constable', 'sister', '', 0, '2017-03-28', '2099-01-01', 'CGHS Dispensary ', 'Greater Noida', '66/SE', NULL, '3191', 'Yatharth Hospital', 5201240, '2021-11-30', 5215642, '2021-12-31', 'General', 'NULL', '2017-03-30', '2017-03-30', 0.00, 0.00, NULL, 'HAG', '29864', 'PERMISSION', 'NULL', NULL, NULL, 0),
(164, 'Pawan Kumar', '27130166', 'Head Constable', 'mother ', '', 0, '2017-03-27', '2099-01-01', 'CGHS Dispensary ', 'M.B. Road, New Delhi', '66/SE', NULL, '3190', 'Batra Hospital & Research centre ', 5201240, '2021-11-30', 5215632, '2021-12-31', 'General', 'NULL', '2017-03-30', '2017-03-30', 0.00, 0.00, NULL, 'HAG', '29865', 'PERMISSION', 'NULL', NULL, NULL, 0),
(165, 'Manoj Kumar Yadav', '27130194', 'Head Constable', 'daughter', '', 0, '2017-03-28', '2099-01-01', 'Yashoda Hospitals & Research Centre ', 'Ghaziabad ', '71/SE', NULL, '3196', 'NULL', 4677913, '2020-06-30', 5337356, '2047-07-31', 'General', 'NULL', '2017-03-30', '2017-03-30', 9803.00, 11283.00, NULL, 'HAG', '29864', 'CREDIT', 'NULL', NULL, NULL, 0),
(166, 'Ram Dayal Meena ', '28960942', 'Assistant Sub-Inspector', 'Mother', '', 0, '2017-03-31', '2099-01-01', 'BATRA HOSPITAL & MEDICAL RESEARCH CENTRE', '1, Tughlakabad Institutional Area, Mehrauli Badarpur Road New Delhi -62', '101/SE', NULL, '3257', 'NULL', 172698, '2021-08-31', 172700, '2021-08-31', 'General', 'NULL', '2017-03-31', '2017-03-31', 0.00, 0.00, NULL, 'HAG', '29861', 'CREDIT', 'NULL', NULL, NULL, 0),
(167, 'Wasim Khan ', '29103056', 'Constable', 'wife', '', 0, '2017-03-30', '2099-01-01', 'Apex Citi Hospital', 'Patpargajn, New Delhi', '3815/SE', NULL, '3258', 'NULL', 5322803, '2046-10-31', 5322805, '2046-10-31', 'General', 'NULL', '2017-03-31', '2017-03-31', 0.00, 0.00, NULL, 'HAG', '29862', 'CREDIT', 'NULL', NULL, NULL, 0),
(168, 'Yajurvander sharma', '28981900', 'Head Constable', 'father', '', 0, '2017-04-01', '2099-01-01', 'Kailash Hospital & Heart Institute ', 'Sec-27, Noida ', '2356/SE', NULL, '3266', 'NULL', 250705, '2036-12-31', 250707, '2036-12-31', 'General', 'NULL', '2017-04-01', '2017-04-01', 0.00, 0.00, NULL, 'HAG', '29860', 'CREDIT', 'NULL', NULL, NULL, 0),
(169, 'Natholi Ram ', '28822380', 'Assistant Sub-Inspector', 'own', '', 0, '2017-04-03', '2099-01-01', 'Cygnus Orthocare Hospital ', 'Opp. main Gate, Safdarjung Area, New Delhi', '2513/SE', NULL, '3268', 'NULL', 262763, '2020-06-30', 0, '2099-01-01', 'Semi-Private', 'NULL', '2017-04-03', '2017-04-03', 0.00, 0.00, NULL, 'HAG', '29858', 'CREDIT', 'NULL', NULL, NULL, 0),
(170, 'Safi Ahmed', '28950367', 'Head Constable', 'own', '', 0, '2017-03-31', '2099-01-01', 'Kailash Hospital & Heart Institute ', 'H-33, Sec-27, Noida', '1201/SE', NULL, '3267', 'NULL', 3928288, '2017-12-31', 0, '2099-01-01', 'General', 'NULL', '2017-04-03', '2017-04-03', 0.00, 0.00, NULL, 'HAG', '29861', 'CREDIT', 'NULL', NULL, NULL, 0),
(171, 'Dharam Bir ', '28931839', 'Assistant Sub-Inspector', 'mother', '', 0, '2017-03-31', '2099-01-01', 'Metro Hospital Institute With Multispeciality ', 'Sec-16A, Faridabad ', '998/SE', NULL, '3269', 'NULL', 3868189, '2017-10-31', 3868192, '2017-10-31', 'General', 'NULL', '2017-04-03', '2017-04-03', 0.00, 0.00, NULL, 'HAG', '29861', 'CREDIT', 'NULL', NULL, NULL, 0),
(172, 'Inderjeet Singh', '16810023', 'Inspector', 'wife ', '', 0, '2017-04-01', '2099-01-01', 'Asian Institute of Medical Sciences ', 'Sector-21A, Faridabad ', 'D-I/97', NULL, '3270', 'Asian Institute of Medical Sciences ', 4016324, '2018-07-31', 4016329, '2018-07-31', 'Private', 'NULL', '2017-04-03', '2017-04-03', 0.00, 0.00, NULL, 'HAG', '29860', 'PERMISSION', 'NULL', NULL, NULL, 0),
(173, 'Ram Chand', '28970083', 'Head Constable', 'son', 'Nishant Panwar', NULL, '05/04/2017', NULL, 'CGHS Dispensary ', 'Safdarjung Enclave, New Delhi', '1028/SE', NULL, '3361', 'Centre for Sight Hospital ', 5041666, '31.08.2021', 5041747, '31.08.2021', 'General', NULL, '2017-04-06', '06.04.2017', NULL, NULL, NULL, 'HAG', '0', 'PERMISSION', 'NULL', NULL, NULL, NULL),
(174, 'Vishwanath Nath', '28881971', 'Head Constable', 'self', 'no name', NULL, '29/03/2017', NULL, 'Safdarjung Hospital ', 'Greater Kailash, New Delhi', '2030/SE', NULL, '3254', 'R.G. Stone Hospital ', 183967, '31.08.2021', 0, '00-00-0000', 'General', NULL, '2017-04-06', '31.03.17', NULL, NULL, NULL, 'HAG', '0', 'PERMISSION', 'NULL', NULL, NULL, NULL),
(175, 'Puran Mal', '28810558', 'Assistant Sub-Inspector', 'wife', 'Meena Devi', NULL, '27/03/2017', NULL, 'Safdarjung Hospital ', 'Greater Kailash, New Delhi', '538/SE', NULL, '3359', 'R.G. Stone Hospital ', 201341, '31.08.2020', 201342, '31.08.2020', 'General', NULL, '2017-04-06', '06.04.2017', NULL, NULL, NULL, 'HAG', '0', 'PERMISSION', 'NULL', NULL, NULL, NULL),
(176, 'Om Prakash', '28932536', 'Assistant Sub-Inspector', 'wife', 'Prakashi Devi', NULL, '06/04/2017', NULL, 'Batra Hospital & Medical Research Centre ', 'M.B. Road, New Delhi', '214/SE', NULL, '3373', NULL, 3961355, '31.03.2018', 3961357, '31.03.2018', 'General', NULL, '2017-04-06', '06.04.17', NULL, NULL, NULL, 'HAG', '0', 'CREDIT', 'NULL', NULL, NULL, NULL),
(177, 'Om Prakash', '28932536', 'Assistant Sub-Inspector', 'wife', 'Prakashi Devi', NULL, '06/04/2017', NULL, 'Batra Hospital & Medical Research Centre ', 'M.B. Road, New Delhi', '214/SE', NULL, '3373', NULL, 3961355, '31.03.2018', 3961357, '31.03.2018', 'General', NULL, '2017-04-06', '06.04.17', NULL, NULL, NULL, 'HAG', '0', 'CREDIT', 'NULL', NULL, NULL, NULL),
(178, 'Sakshi', '28141467', 'W/Constable', 'mother ', 'Rajbala', NULL, '06/04/2017', NULL, 'Safdarjung Hospital ', 'Vikas Marg, Delhi', '4068/SE', NULL, '3456', 'Sharp Centre ', 5060152, '31.03.2051', 5060163, '31.03.2051', 'General', NULL, '2017-04-07', '07.04.2017', NULL, NULL, NULL, 'HAG', '0', 'PERMISSION', 'NULL', NULL, NULL, NULL),
(179, 'Umesh Kant', '28930230', 'Head Constable', 'mother', 'Hemlata', NULL, '07/04/2017', NULL, 'Kalra Hospital ', 'Kirti Nagar, New Delhi', '2070/SE', NULL, '3457', NULL, 27047798, '31.12.2031', 2704809, '31.12.2031', 'General', NULL, '2017-04-07', '07.04.2017', NULL, NULL, NULL, 'HAG', '0', 'CREDIT', 'NULL', NULL, NULL, NULL),
(180, 'Sandeep kumar', '29101397', 'Constable', 'self', 'no name', NULL, '06/04/2017', NULL, 'Bansal Hospital ', 'A-1, New Friends Colony, New Delhi', '3598/SE', NULL, '3441', NULL, 3691720, '30.09.2050', 0, '00-00-0000', 'General', NULL, '2017-04-07', '07.04.2017', NULL, NULL, NULL, 'HAG', '0', 'CREDIT', 'NULL', NULL, NULL, NULL),
(181, 'Sher Singh ', '28900754', 'Assistant Sub-Inspector', 'wife', 'Geeta Attri', NULL, '07/04/2017', NULL, 'Safdarjung Hospital ', 'Sec-128, Noida ', '420/SE', NULL, '3458', 'Jaypee Hospital ', 3836126, '31.10.2017', 3836127, '31.10.2017', 'General', NULL, '2017-04-07', '07.04.2017', NULL, NULL, NULL, 'HAG', '0', 'PERMISSION', 'NULL', NULL, NULL, NULL),
(182, 'Amit Tyagi', '27080056', 'Head Constable', 'Mother', 'Sheela Devi', NULL, '27/02/2017', NULL, 'Narang Eye Institute', '', '22/SE', NULL, '3302', NULL, 3402277, 'Aug 2021', 3764922, 'June 2017', 'General', NULL, '2017-04-10', '05/04/2017', NULL, NULL, NULL, 'HAG', '0', 'OP_REFERRAL', 'NULL', NULL, NULL, NULL),
(183, 'test', '123456', 'Head Constable', 'self', 'no name', NULL, '10/04/2017', NULL, 'aiims', '', '1234/se', NULL, '2345', NULL, 123456879, '10/04/2017', 0, '00-00-0000', 'General', NULL, '2017-04-10', '10/04/2017', 289.00, 358.00, NULL, 'HAG', '0', 'OP_REFERRAL', 'NULL', NULL, NULL, NULL),
(184, 'Amit Tyagi', '27080056', 'Head Constable', 'Mother', 'Sheela Devi', NULL, '22/02/2017', NULL, 'Narang Eye Institute', '', '22/SE', NULL, '3302', NULL, 3402277, 'Aug 2021', 3764922, 'Jun 2017', 'General', NULL, '2017-04-10', '05/04/2017', 17159.00, 17159.00, NULL, 'HAG', '0', 'OP_REFERRAL', 'NULL', NULL, NULL, NULL);
...
INSERT INTO `logs` (`user_name`, `time`, `action`, `diary_no`) VALUES
('Dealing Hand', '2017-02-05 16:47:44', 'Added new referral case', NULL);
...
CREATE TABLE `medical` (
  ...
  `bill_no_hosp` varchar(100) DEFAULT NULL,
  `date` varchar(20) DEFAULT NULL,
  `amt_asked` float(7,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `medical` (`app_id`, `s_no`, `treatment`, `total`, `index`, `bill_no_hosp`, `date`, `amt_asked`) VALUES
(68, 1492, 'Prothrombin Time (P.T.)', 127.00, NULL, '16-17/7709', '2016-11-29', 127.00),
(68, 1424, 'HBs Ag', 120.00, NULL, '16-17/7709', '2016-11-29', 120.00),
(68, 1425, 'HCV', 150.00, NULL, '16-17/7709', '2016-11-29', 150.00),
(68, 1426, 'HIV I and II', 173.00, NULL, '16-17/7709', '2016-11-29', 173.00),
(73, 345, 'Genioplasty', 13800.00, NULL, 'aiims', '2017-02-10', 4356.00),
(74, 511, 'Room Rent  ', 3000.00, NULL, '16-17CR1944', '2017-01-22', 3000.00),
(74, 2, 'Consultation- for Inpatients', 2100.00, NULL, '16-17CR1944', '2017-01-22', 2100.00),
(74, 3, 'Laboratory', 4698.00, NULL, '16-17CR1944', '2017-01-22', 4698.00),
(74, 4, 'X Ray  ', 670.00, NULL, '16-17CR1944', '2017-01-22', 670.00),
(74, 72, 'Ultrasound  ', 380.00, NULL, '16-17CR1944', '2017-01-22', 380.00),
(74, 5, 'Cardiology', 58.00, NULL, '16-17CR1944', '2017-01-22', 58.00),
(74, 6, 'Discharge Patient medicine', 223.20, NULL, '16-17CR1944', '2017-01-22', 223.00),
(74, 7, 'Main Pharmacy', 6037.85, NULL, '16-17CR1944', '2017-01-22', 6038.00),
(74, 8, 'Pharmacy Return ', -246.92, NULL, '16-17CR1944', '2017-01-22', -247.00),
(75, 1, 'Consultation OPD', 150.23, NULL, '1234', '2014-02-22', 150.00),
(89, 1, 'room charge ', 4000.00, NULL, '201610003', '2017-01-06', 4000.00),
(89, 2, 'Pathology Lab', 3424.00, NULL, '201610003', '2017-01-06', 3424.00),
(89, 3, 'Radiology ', 2950.00, NULL, '201610003', '2017-01-06', 2950.00),
(89, 4, 'Neurology ', 750.00, NULL, '201610003', '2017-01-06', 750.00),
(89, 5, 'Gastroenterology ', 660.00, NULL, '201610003', '2017-01-06', 660.00),
(89, 6, 'Medicines & Consumable ', 5306.00, NULL, '201610003', '2017-01-06', 5306.00),
(89, 7, 'Discharge Medicine ', 1043.00, NULL, '201610003', '2017-01-06', 1043.00),
(89, 8, 'Dr Visit Charge ', 3900.00, NULL, '201610003', '2017-01-06', 3900.00),
(90, 1, 'Room rent  ', 6726.00, NULL, '16-17/6107', '2017-01-19', 6726.00),
(90, 2, 'Dr. Visit Fees ', 3000.00, NULL, '16-17/6107', '2017-01-19', 3000.00),
(90, 1, 'Room rent  ', 6726.00, NULL, '16-17/6107', '2017-01-19', 6726.00),
(90, 2, 'Dr. Visit Fees ', 3000.00, NULL, '16-17/6107', '2017-01-19', 3000.00),
(91, 15, 'Sternal puncture', 199.00, NULL, 'sjh', '2017-03-18', 200.00),
(92, 25, 'Excision of Molluscum contagiosum', 150.00, NULL, '2341 sjh ', '2017-03-16', 123.67),
(92, 0, 'Consultation OPD', 150.00, NULL, ' ', '3012-02-23', 256.23),
(95, 1, 'room rent ', 6726.00, NULL, '16-17/6107', '2017-01-19', 6726.00),
(95, 2, 'Dr. Visit fees', 3000.00, NULL, '16-17/6107', '2017-01-19', 3000.00),
(95, 3, 'Compressed air / piped oxygen /per hour', 2784.00, NULL, '16-17/6107', '2017-01-19', 2784.00),
(95, 4, 'nebulisation charge ', 870.00, NULL, '16-17/6107', '2017-01-19', 870.00),
(95, 5, 'Discharge medicine ', 1271.00, NULL, '16-17/6107', '2017-01-19', 1271.00),
(95, 6, 'laboratory ', 3203.00, NULL, '16-17/6107', '2017-01-19', 3203.00),
(95, 7, 'Radiology ', 1957.00, NULL, '16-17/6107', '2017-01-19', 1957.00),
(95, 8, 'Medicines & Consumables ', 20756.70, NULL, '16-17/6107', '2017-01-19', 20756.70),
(95, 1, 'Haemorrhoidectomy', 21938.00, NULL, '160009691', '2017-02-23', 21938.00),
(95, 2, 'Fissure in Ano - Fissurectomy', 7141.50, NULL, '160009691', '2017-02-23', 7141.50),
(96, 1, 'Haemorrhoidectomy', 21938.00, NULL, '160009691', '2017-02-23', 21938.00),
(96, 2, 'Fissure in Ano- Fissurectomy ', 7141.50, NULL, '160009691', '2017-02-23', 7141.50),
(97, 1, 'Room rent', 3726.00, NULL, '201601450', '2017-01-14', 3726.00),
(97, 2, 'Pathology Lab ', 3001.00, NULL, '201601450', '2017-01-14', 3001.00),
(97, 3, 'Radiology ', 70.00, NULL, '201601450', '2017-01-14', 70.00),
(97, 4, 'General nursing & minor procedures ', 1381.00, NULL, '201601450', '2017-01-14', 1381.00),
(97, 5, 'Anti Platelets Therapy  ', 10796.00, NULL, '201601450', '2017-01-14', 10796.00),
(97, 6, 'Oxygen Charges ', 2784.00, NULL, '201601450', '2017-01-14', 2784.00),
(97, 7, 'Stenting ', 47250.00, NULL, '201601450', '2017-01-14', 47250.00),
(97, 8, 'Medicines & Consumables ', 5262.00, NULL, '201601450', '2017-01-14', 5372.00),
(97, 9, 'Dr Visit charges ', 1200.00, NULL, '201601450', '2017-01-14', 1200.00),
(97, 10, 'Coronary angiography', 11902.00, NULL, '201601450', '2017-01-14', 11902.00),
(97, 11, 'Balloon coronary angioplasty/PTCA with VCD', 83421.00, NULL, '201601450', '2017-01-14', 83421.00),
(98, 1, 'Blood transfusion charge ', 610.00, NULL, '16-17/5919', '2017-01-05', 610.00),
(98, 2, 'Room rent ', 11589.00, NULL, '16-17/5919', '2017-01-05', 11589.00),
(98, 3, 'Dr. visit fees', 6000.00, NULL, '16-17/5919', '2017-01-05', 6000.00),
(98, 4, 'Compressed air / piped oxygen /per hour', 4176.00, NULL, '16-17/5919', '2017-01-05', 4176.00),
(98, 5, 'Discharge Medicine ', 1911.00, NULL, '16-17/5919', '2017-01-05', 1911.00),
(98, 6, 'Nebulisation Charges ', 1566.00, NULL, '16-17/5919', '2017-01-05', 1566.00),
(98, 7, 'Blood charges ', 3400.00, NULL, '16-17/5919', '2017-01-05', 3400.00),
(98, 8, 'Laboratory ', 5890.00, NULL, '16-17/5919', '2017-01-05', 5890.00),
(98, 9, 'Radiology ', 11283.00, NULL, '16-17/5919', '2017-01-05', 11283.00),
(98, 10, 'Medicine & Consumables ', 13359.80, NULL, '16-17/5919', '2017-01-05', 13359.80),
(99, 1, 'stepwise devascularisation', 4761.00, NULL, 'BC17/00677', '2017-02-15', 4761.00),
(99, 2, 'Sterilization interval (minilap)', 1941.00, NULL, 'BC17/00677', '2017-02-15', 1941.00),
(99, 3, 'Exploration of abdominal Haematoma (after laparotomy +LSCS)', 4166.00, NULL, 'BC17/00677', '2017-02-15', 4166.00),
(99, 4, 'Cesarean Section', 14543.00, NULL, 'BC17/00677', '2017-02-15', 14543.00),
(99, 5, 'room charge ', 4000.00, NULL, 'BC17/00699', '2017-02-16', 4000.00),
(99, 6, 'Dr. Visit fees ', 2100.00, NULL, 'BC17/00699', '2017-02-16', 2100.00),
(99, 7, 'Laboratory charges ', 1800.00, NULL, 'BC17/00699', '2017-02-16', 1800.00),
(99, 8, 'Pharmacy ', 80.00, NULL, 'BC17/00699', '2017-02-16', 80.00),
(99, 9, 'Otoacoutric emmission  ', 600.00, NULL, 'BC17/00699', '2017-02-16', 600.00),
(99, 10, 'Vaccination Charges ', 700.00, NULL, 'BC17/00699', '2017-02-16', 700.00),
(99, 11, 'Treatment procedure ICU/CCU procedure ', 854.00, NULL, 'BC17/00699', '2017-02-16', 854.00),
(99, 12, 'Laboratory medicine/ Haematology ', 1107.00, NULL, 'BC17/00699', '2017-02-16', 1107.00),
(125, 1, 'room rent ', 5863.00, NULL, '2016/34688', '2017-03-04', 5863.00),
(125, 2, 'Dr. visit ', 3000.00, NULL, '2016/34688', '2017-03-04', 3000.00),
(125, 3, 'Cardiology ', 3048.00, NULL, '2016/34688', '2017-03-04', 3048.00),
(125, 4, 'Pathology ', 1831.00, NULL, '2016/34688', '2017-03-04', 1831.00),
(125, 5, 'Radiology ', 70.00, NULL, '2016/34688', '2017-03-04', 70.00),
(125, 6, 'Hospital consumables ', 2665.69, NULL, '2016/34688', '2017-03-04', 2665.69),
(125, 7, 'Medicine from store ', 852.07, NULL, '2016/34688', '2017-03-04', 852.07),
(125, 1, 'Room rent ', 5726.00, NULL, '2016/34850', '2017-03-10', 7726.00),
(125, 2, 'Dr. Visit ', 3000.00, NULL, '2016/34850', '2017-03-10', 3000.00),
(125, 3, 'Cardiology ', 1496.00, NULL, '2016/34850', '2017-03-10', 1496.00),
(125, 4, 'Pathalogy ', 1641.00, NULL, '2016/34850', '2017-03-10', 1641.00),
(125, 5, 'Radiology ', 70.00, NULL, '2016/34850', '2017-03-10', 70.00),
(125, 6, 'Hospital Consumables ', 2480.97, NULL, '2016/34850', '2017-03-10', 2480.97),
(125, 7, 'Medicine from store ', 12138.90, NULL, '2016/34850', '2017-03-10', 12138.90),
(125, 8, 'IPD Dialysis ', 6900.00, NULL, '2016/34850', '2017-03-10', 6900.00),
(126, 1, 'Room rent', 5726.00, NULL, '2016/34850', '2017-03-10', 7726.00),
(126, 2, 'Dr. Visit', 3000.00, NULL, '2016/34850', '2017-03-10', 3000.00),
(126, 3, 'Cardiology ', 1496.00, NULL, '2016/34850', '2017-03-10', 1496.00),
(126, 4, 'Pathalogy ', 1641.00, NULL, '2016/34850', '2017-03-10', 1641.00),
(126, 5, 'Radiology ', 70.00, NULL, '2016/34850', '2017-03-10', 70.00),
(126, 6, 'Hospital Consumables ', 2480.97, NULL, '2016/34850', '2017-03-10', 2480.97),
(126, 7, 'Medicine from store ', 12138.90, NULL, '2016/34850', '2017-03-10', 12138.90),
(126, 8, 'IPD Dialysis ', 6900.00, NULL, '2016/34850', '2017-03-10', 6900.00),
(127, 1, 'Room rent ', 3000.00, NULL, 'IP69388', '2017-03-09', 3000.00),
(127, 2, 'Imaging ', 450.00, NULL, 'IP69388', '2017-03-09', 450.00),
(127, 3, 'Lab ', 2576.00, NULL, 'IP69388', '2017-03-09', 2576.00),
(127, 4, 'Dr. visit fees ', 2100.00, NULL, 'IP69388', '2017-03-09', 2100.00),
(127, 5, 'Non-invasive cardiac lab', 1438.00, NULL, 'IP69388', '2017-03-09', 1438.00),
(127, 6, 'Nuclear medicine ', 104.00, NULL, 'IP69388', '2017-03-09', 104.00),
(127, 7, 'Hospital Pharmacy ', 1558.28, NULL, 'IP69388', '2017-03-09', 1558.28),
(128, 1, 'Room rent ', 3000.00, NULL, 'IP69387', '2017-03-09', 3000.00),
(128, 2, 'Imaging', 450.00, NULL, 'IP69387', '2017-03-09', 450.00),
(128, 3, 'Lab ', 2750.00, NULL, 'IP69387', '2017-03-09', 2750.00),
(128, 4, 'Dr. Visit fees ', 2100.00, NULL, 'IP69387', '2017-03-09', 2100.00),
(128, 5, 'Non-invasive cardiac lab ', 58.00, NULL, 'IP69387', '2017-03-09', 58.00),
(128, 6, 'Blood sugar test ', 336.00, NULL, 'IP69387', '2017-03-09', 336.00),
(128, 7, 'Nuclear medicine ', 104.00, NULL, 'IP69387', '2017-03-09', 104.00),
(128, 8, 'Hospital Pharmacy ', 1433.14, NULL, 'IP69387', '2017-03-09', 1433.14),
(130, 1, 'Room rent', 7000.00, NULL, 'IP68882', '2017-02-23', 7000.00),
(130, 2, 'Imaging ', 7315.00, NULL, 'IP68882', '2017-02-23', 7315.00),
(130, 3, 'Lab ', 3767.00, NULL, 'IP68882', '2017-02-23', 3767.00),
(130, 4, 'Dr. Visit fees ', 4500.00, NULL, 'IP68882', '2017-02-23', 4500.00),
(130, 5, 'Blood sugar test ', 532.00, NULL, 'IP68882', '2017-02-23', 532.00),
(130, 6, 'Nuclear medicine ', 230.00, NULL, 'IP68882', '2017-02-23', 230.00),
(130, 7, 'Hospital Pharmacy ', 24413.50, NULL, 'IP68882', '2017-02-23', 24413.50),
(131, 1, 'Room rent', 7000.00, NULL, 'IP68882', '2017-02-23', 7000.00),
(131, 2, 'Imaging ', 7315.00, NULL, 'IP68882', '2017-02-23', 7315.00),
(131, 3, 'Lab ', 3767.00, NULL, 'IP68882', '2017-02-23', 3767.00),
(131, 4, 'Dr. Visit fees ', 4500.00, NULL, 'IP68882', '2017-02-23', 4500.00),
(131, 5, 'Blood sugar test ', 532.00, NULL, 'IP68882', '2017-02-23', 532.00),
(131, 6, 'Nuclear medicine ', 230.00, NULL, 'IP68882', '2017-02-23', 230.00),
(131, 7, 'Hospital pharmacy ', 24413.30, NULL, 'IP68882', '2017-02-23', 24413.50),
(141, 1, 'Room rent', 3000.00, NULL, '16021719', '2017-03-08', 3000.00),
(141, 2, 'Dr. Visit ', 2700.00, NULL, '16021719', '2017-03-08', 2700.00),
(141, 3, 'Nebulization ', 960.00, NULL, '16021719', '2017-03-08', 960.00),
(141, 4, 'Laboratory ', 3934.00, NULL, '16021719', '2017-03-08', 3934.00),
(141, 5, 'Radiology', 70.00, NULL, '16021719', '2017-03-08', 70.00),
(141, 6, 'Medicine ', 3224.15, NULL, '16021719', '2017-03-08', 3224.15),
(142, 1, 'Room rent', 2863.00, NULL, '16021742', '2017-03-08', 2863.00),
(142, 2, 'Dr. Visit', 2400.00, NULL, '16021742', '2017-03-08', 2400.00),
(142, 3, 'Fibroptic examition of Larynx under LA', 1984.00, NULL, '16021742', '2017-03-08', 1984.00),
(142, 4, 'Laboratory ', 56.00, NULL, '16021742', '2017-03-08', 56.00),
(142, 5, 'Cardiology ', 50.00, NULL, '16021742', '2017-03-08', 50.00),
(142, 6, 'Medicine ', 1647.14, NULL, '16021742', '2017-03-08', 1647.14),
(143, 1, 'Room rent ', 5000.00, NULL, '16/13734', '2017-03-11', 5000.00),
(143, 2, 'Dr.Visit fees ', 3000.00, NULL, '16/13734', '2017-03-11', 3000.00),
(143, 3, 'Dressing ', 116.00, NULL, '16/13734', '2017-03-11', 116.00),
(143, 4, 'Laboratory ', 1904.00, NULL, '16/13734', '2017-03-11', 1904.00),
(143, 5, 'Investigation & Imaging ', 58.00, NULL, '16/13734', '2017-03-11', 58.00),
(143, 6, 'External Medicine ', 8121.00, NULL, '16/13734', '2017-03-11', 8121.00),
(144, 1, 'Skin Flaps - Advancement Flaps', 12938.00, NULL, '16021510', '2017-02-04', 12938.00),
(145, 1, 'Room rent', 10726.00, NULL, '16-17CR4993', '2017-02-02', 10726.00),
(145, 2, 'Laboratory ', 4452.00, NULL, '16-17CR4993', '2017-02-02', 4452.00),
(145, 3, 'Cardiac Lab ', 1650.00, NULL, '16-17CR4993', '2017-02-02', 1650.00),
(145, 4, 'Physiotherapy ', 164.00, NULL, '16-17CR4993', '0017-02-02', 164.00),
(145, 5, 'MISC ', 0.00, NULL, '16-17CR4993', '2017-02-02', 600.00),
(145, 6, 'CT Scan ', 1035.00, NULL, '16-17CR4993', '2017-02-02', 1035.00),
(145, 7, 'ICU Procedures ', 2442.00, NULL, '16-17CR4993', '2017-02-02', 2442.00),
(145, 8, 'Dr. Visit fees', 6600.00, NULL, '16-17CR4993', '2017-02-02', 6600.00),
(145, 9, 'Ultrasound ', 380.00, NULL, '16-17CR4993', '2017-02-02', 380.00),
(145, 10, 'X-ray ', 140.00, NULL, '16-17CR4993', '2017-02-02', 140.00),
(145, 11, 'Emergency room charges ', 1396.00, NULL, '16-17CR4993', '2017-02-02', 1396.00),
(145, 12, 'Pharmacy ', 14625.70, NULL, '16-17CR4993', '2017-02-02', 14625.70),
(151, 1, 'Room rent', 2863.00, NULL, '16-17CR4583', '2017-01-05', 2863.00),
(151, 2, 'Laboratory ', 1290.00, NULL, '16-17CR4583', '2017-01-05', 1290.00),
(151, 3, 'Cardiac Lab ', 1650.00, NULL, '16-17CR4583', '2017-01-05', 1650.00),
(151, 4, 'MISC ', 0.00, NULL, '16-17CR4583', '2017-01-05', 600.00),
(151, 5, 'ICU Procedures ', 1692.00, NULL, '16-17CR4583', '2017-01-05', 1692.00),
(151, 6, 'Dr. Visit fees ', 1500.00, NULL, '16-17CR4583', '2017-01-05', 1500.00),
(151, 7, 'Emergency room charge ', 1274.00, NULL, '16-17CR4583', '2017-01-05', 1274.00),
(151, 8, 'Pharmacy ', 5586.37, NULL, '16-17CR4583', '2017-01-05', 5586.37),
(151, 9, 'Pharmacy return ', -91.66, NULL, '16-17CR4583', '2017-01-05', -91.66),
(153, 1, 'Room charge ', 34000.00, NULL, '16-17CR4087', '2016-12-01', 34000.00),
(153, 2, 'Laboratory ', 7410.00, NULL, '16-17CR4087', '2016-12-01', 7410.00),
(153, 3, 'Ophthalmology ', 1180.00, NULL, '16-17CR4087', '2016-12-01', 1180.00),
(153, 4, 'Cardiac Lab ', 1650.00, NULL, '16-17CR4087', '2016-12-01', 1650.00),
(153, 5, 'Physiotherapy ', 1640.00, NULL, '16-17CR4087', '2016-12-01', 1640.00),
(153, 6, 'Room Procedures ', 200.00, NULL, '16-17CR4087', '2016-12-01', 200.00),
(153, 7, 'MISC ', 9600.00, NULL, '16-17CR4087', '2016-12-01', 10200.00),
(153, 8, 'ICU Procedures ', 15312.00, NULL, '16-17CR4087', '2016-12-01', 15312.00),
(153, 9, 'Dr. Visit ', 14100.00, NULL, '16-17CR4087', '2016-12-01', 14100.00),
(153, 10, 'X-ray ', 280.00, NULL, '16-17CR4087', '2016-12-01', 280.00),
(153, 11, 'Emergency room charges ', 86.00, NULL, '16-17CR4087', '2016-12-01', 86.00),
(153, 12, 'Pharmacy ', 46741.70, NULL, '16-17CR4087', '2016-12-01', 46741.70),
(153, 13, 'Pharmacy return ', -2691.02, NULL, '16-17CR4087', '2016-12-01', -2691.02),
(183, 2, 'Consultation- for Inpatients', 300.00, NULL, '1245', '24/02/2017', 256.00),
(183, 3, 'Dressings of wounds', 58.00, NULL, ' ', '', 33.00),
(184, 72, 'Ultrasound A- Scan', 992.00, NULL, '7468', '27/02/2017', 992.00),
(184, 0, 'Consultation and Procedure', 325.00, NULL, '7469', '27/02/2017', 325.00),
(184, 156, 'Phaco with foldable IOL (silicone and acrylic)/PMMA IOL', 10042.38, NULL, '4143', '03/03/2017', 10042.38),
(184, 0, 'Cost of lens', 5800.00, NULL, ' ', '', 5800.00);
...
CREATE TABLE `products` (
  ...
  `productName` varchar(110) DEFAULT NULL,
  `non_nabh_nabl` varchar(13) DEFAULT NULL,
  `nabh_nabl` varchar(11) DEFAULT NULL
...
INSERT INTO `products` (`productCode`, `productName`, `non_nabh_nabl`, `nabh_nabl`) VALUES
...
('28', 'I/D Injection Keloid', '97', '112'),
...
('34', 'Conjunctival wound repair or exploration following blunt\ntrauma', '3300', '3795'),
...
('53', 'DSAEK- Descemet?s stripping automated endothelial\nkeratoplasty', '16675', '19176'),
...
('58', 'Dacryocystorhinostomy?Plain with intubation and/or with\nlacrimal implants', '9750', '11213'),
...
('158', 'Secondary IOL implantation- AC IOL PC IOL or scleral\nfixated IOL', '6900', '7935'),
('159', 'Cataract extraction with IOL with capsular tension rings\n(Cionni?s ring)', '13500', '15525'),
...
('187', 'Extraction in mentally retarded/patients with systemic\ndiseases/patient with special needs under short term GA', '939', '1080'),
('188', 'Cyst & tumour of Maxilla /mandible by enucleation/\nexcision/ marsupalisation upto 4 cms under LA', '244', '281'),
('189', 'Cyst & tumour of Maxilla/mandible by enucleation/\n\n\nexcision/ marsupalisation size more than  4 cms under LA', '406', '467'),
('190', 'Cyst & tumour of Maxilla/mandible by\nenucleation/excision/marsupalisation size more than 4 cms under GA', '1000', '1150'),
...
('202', 'Release of fibrous bands & grafting -in (OSMF) treatment\nunder GA', '1500', '1725'),
...
('228', 'Maxillo-facial prosthesis (sal/auricular/orbital/facial lost\npart)', '3500', '4025'),
...
('281', 'Mastoidectomy plus Ossciculoplasty including TORP or\nPORP', '2415', '2777'),
...
('301', 'Excision of Pinna for Growth (Squamous/Basal/ Injuries)\nSkin Only', '4000', '4600'),
('302', 'Excision of Pinna for Growth (Squamous/Basal/ Injuries)\nSkin and Cartilage', '3800', '4370'),
...
('317', 'Operation for Carcinoma Lip - Wedge Excision and\nVermilonectomy', '9292', '10686'),
...
('393', 'Vericose vein surgery;Tendelenburg operation with suturing\nor ligation.', '10000', '11500'),
...
('464', 'Operations for Recurrent Intestinal Obstruction (Noble\nPlication & Other Operations for Adhesions)', '23000', '26450'),
...
('476', 'Fissure in Ano with Internal sphinctrectomy with\nfissurectomy.', '13800', '15870'),
...
('523', 'B.D.Glenn/Left atrium myxoma', '80750', '95000'),
...
('539', 'P.A.Banding septostomy', '51980', '59777'),
...
('624', 'Laproscopic Broad Ligament Hematoma Drainage with\nrepair', '6900', '7935'),
('625', 'Exploration of perineal Haematoma & Repair', '8000', '9200'),
('626', 'Exploration of abdominal Haematoma (after laparotomy +\nLSCS)', '8050', '9258'),
...
('640', 'Abdominal Hysterectomy with or without salpingo-\noophorectomy', '17250', '19838'),
...
('650', 'Shirodkar?s sling Operation or other sling operations for\nprolapse uterus', '3450', '3968'),
...
('658', 'Laparoscopy -Diagnostic with chromopertubation and or\nadhesiolysis and drilling', '4025', '4629'),
...
('663', 'Laparoscopic treatment of Ectopic pregnancy-\nsalpingectomy/salpinostomy conservative', '9775', '11241'),
...
('667', 'Laparotomy recannalization of Fallopian tubes-\n(Tubuloplasty)', '22425', '25789'),
('668', 'Laparoscopic recannalization of Fallopian tubes-\n(Tubuloplasty)', '19500', '22425'),
...
('689', 'Transvaginal sonography (TVS for Follicular monitioring\n/aspiration)', '460', '529'),
...
('704', 'Radical Hysterectomy for Cancer cervix with pelvic\nlymphadenectomy', '8500', '9775'),
('705', 'Radical Hysterectomy for Cancer endometrium extending\n\n\nto cervix with pelvic and para aortic lymphadenectomy', '8500', '9775'),
...
('730', 'Percutaneous Drainage of Perinephric Abscess -Ultrasound\nguided', '5750', ''),
...
('742', 'Operations for Vesico- ureteric Reflux/ Urinary incontinence\nwith bulking agents', '20700', '23805'),
...
('758', 'Operations for Extrophy of the Bladder- simple cystectomy\nwith urinary diversion', '22500', '25875'),
...
('769', 'Urethral Reconstruction - substitution urethroplasty\n(Transpubic urethroplasty', '19550', '22483'),
...
('792', 'Post Radical Orchidectomy retroperitoneal lymph node\ndissection.', '14000', '16100'),
('793', 'Epididymectomy', '15938', '18750'),
('794', 'Adreneclectomy Unilateral/Bilateral for Tumour/For\nCarcinoma- Open', '25300', '29095'),
('795', 'Adreneclectomy Unilateral/Bilateral for Tumour/For\nCarcinoma -Lap/Endoscopic', '14375', '16531'),
...
('799', 'Micro-surgical Vasovasostomy /Vaso epidedymal\nansatamosis.', '11040', '12696'),
...
('804', 'Block Dissection of ilio-inguinal Nodes - One Side (For Ca-\nPenis)', '6325', '7274'),
('805', 'Block Dissection of ilio-inguinal Nodes - Both Sides (For Ca-\nPenis)', '23000', '26450'),
('806', 'Excision of Filarial Scrotum', '11500', '13225'),
('807', 'Kidney Transplantation (related)', '200000', '230000'),
('808', 'Kidney Transplantation (Spousal/ unrelated) Including\nimmunosuppressant therapy', '300000', '345000'),
...
('815', 'Kidney Transplant with Native Kidney Nephrectomy\n(Related)/ Unilateral', '28000', '32200'),
('816', 'Kidney Transplant with Native Kidney Nephrectomy\n(Related)/ Bilateral', '85000', '97750'),
('817', 'Kidney Transplant with Native Kidney Nephrectomy\n(Spousal/ Unrelated) Unilateral', '85000', '97750'),
('818', 'Kidney Transplant with Native Kidney Nephrectomy\n(Spousal/ Unrelated) Bilateral', '85000', '97750'),
('819', 'Post-Transplant Collection drainage for Lymphocele (open)', '6800', '8000'),
('820', 'Post-Transplant Collection drainage for Lymphocele\n(percutaneous)', '6800', '8000'),
('821', 'Post-Transplant Collection drainage for Lymphocele\n(Laproscopic)', '7650', '9000'),
...
('826', 'One sided (single Lumen) Femoral Catheterization for\nHaemodialysis', '1000', '1150'),
('827', 'Bilateral (single Lumen) Femoral Catheterization for\nHaemodialysis', '1500', '1725'),
...
('862', 'Ureteric Re- implant for Megaureter/Vesicoureteric reflex/\nuterocele (open)', '10494', '12068'),
('863', 'Ureteric Re -implant for Megaureter/Vesicoureteric reflex/\nuterocele (Laproscopic)', '10494', '12068'),
...
('874', 'Resection Bladder Neck Endoscopic /Bladder neck\nincision/transurethral incision on prostrate', '10925', '12564'),
...
('894', 'Voiding-cysto-urethrogram and retrograde urethrogram\n(Nephrostogram)', '414', '476'),
('895', 'Radical prostatectomy-Open', '17825', '20499'),
('896', 'Radical prostatectomy-Laproscopic', '20125', '23144'),
('897', 'Radical prostatectomy- Robotic (Robotic Partial\nNephrectomy)', '20125', '23144'),
...
('905', 'Cystoscopic Botulinum Toxin Injection ( Over active\nbladder/ Neurogenic bladder)', '6800', '7820'),
('906', 'Peyronie?s disease ? Plaque excision with grafting', '3400', '4000'),
('907', 'High Intensity Focus Ultrasound (HIFU) (Robotic) for\nCarcinoma prostrate and renal cell carcinoma', '4600', '5290'),
...
('992', 'Dorsal column stimulation for backache in failed back\nsyndrome', '28750', '33063'),
('993', 'Surgery for recurrent disc prolapse/epidural fibrosis', '32200', '37030'),
('994', 'Surgery for brain stem tumours', '43988', '50586'),
('995', 'Decompressive craniotomy for hemishpherical acute\nsubdural haematoma/brain swelling/large infarct', '40000', '46000'),
...
('999', 'Steriotactic Radiosurgery for brain pathology(X\nknife/Gamma ) - ONE session', '27560', '31694'),
('1000', 'Steriotactic Radiosurgery for brain pathology(X knife /\nGamma knife -Two or more sessions', '57500', '66125'),
...
('1017', 'Diaphragmatic Hernia Repair (Thoracic or Abdominal\nApproach)', '17250', '19838'),
...
('1041', 'Imperforate Anus High Anomaly -Sacroabdomino Perineal\nPull Through', '12500', '14375'),
('1042', 'Imperforate Anus High Anomaly - Closure of Colostomy', '8625', '9919'),
('1043', 'Intususception Operation', '20700', '23805'),
('1044', 'Choledochoduodenostomy for Atresia of Extra Hepatic\nBilliary Duct', '15000', '17250'),
...
('1049', 'Paraortic Lymphadenoctomy with Nephrectomy for Wilms\nTumour', '20000', '23000'),
...
('1080', 'Reduction of Fractures of Mandible & Maxilla - Eye Let\nSplinting', '7475', '8596'),
('1081', 'Reduction of Fractures of Mandible & Maxilla - Cast Netal\nSplints', '6900', '7935'),
('1082', 'Reduction of Fractures of Mandible & Maxilla - Gumming\nSplints', '7500', '8625'),
...
('1095', 'Plastic Surgery for Facial Paralysis (Support with\nReanimation)', '16100', '18515'),
...
('1146', 'Open Reduction offracture of Long Bones of Upper / Lower\nLimb -iling & Exterl Fixation', '8050', '9258'),
('1147', 'Open Reduction of fracture of Long Bones of Upper / Lower\nLimb -AO Procedures', '9660', '11109'),
...
('1156', 'A.O.Compression Procedures for Fracture Neck Femur', '16560', '19044'),
('1157', 'Open Reduction of Fracture Neck Femur Muscle Pedicle\nGraft and Internal Fixations', '19500', '22425'),
...
('1168', 'Anterolateral decompression for tuberculosis/ Costo-\nTransversectomy', '3450', '3968'),
...
('1193', 'Myocutaneous and Fasciocutaneous Flap Procedures for\nLimbs', '18630', '21425'),
...
('1223', 'Illizarov/ external fixation for limb lengthening/ deformity\ncorrection', '12500', '14375'),
...
('1346', 'Brain Perfusion SPECT Scan with Technetium 99m\nradiopharmaceuticals.', '9775', '11241'),
('1347', 'Radionuclide Cisternography for CSF leak', '3740', '4400'),
('1348', 'Gastro esophageal Reflux Study (G.E.R. Study)', '1955', '2248'),
('1349', 'Gastro intestinal Bleed (GloB.) Study with Technetium 99m\nlabeled RBCs.', '3421', '3934'),
('1350', 'Hepatobiliary Scintigraphy.', '2444', '2811'),
('1351', 'Meckel\'s Scan', '1955', '2248'),
('1352', 'Hepatosplenic scintigraphy with Technetium-99m\nradiopharmaceuticals', '1870', '2200'),
...
('1382', 'Gallium-68 Peptide PET / CT imaging for Neuroendocrine\nTumor', '15000', '17250'),
('1383', 'Urine routine- pH, Specific gravity, sugar, protein and\nmicroscopy', '35', '40'),
...
('1394', 'Complete Haemogram/CBC, Hb,RBC count and indices,\n\n\nTLC, DLC, Platelet, ESR, Peripheral smear examination', '135', '155'),
...
('1409', 'Bleeding Disorder panel- PT, APTT, Thrombin Time\nFibrinogen, D-Dimer/ FDP', '400', '460'),
('1410', 'Factor Assays-Factor VIII', '720', '828'),
('1411', 'Factor Assays-Factor IX', '680', '782'),
('1412', 'Platelet Function test', '50', '58'),
('1413', 'Tests for hypercoagulable states- Protein C, Protein S,\nAntithrombin', '400', '460'),
('1414', 'Tests for lupus anticoagulant', '150', '173'),
('1415', 'Tests for  Antiphospholipid antibody IgG, IgM ( for\ncardiolipin and B2 Glycoprotein 1)', '500', '575'),
...
('1520', 'Extended Lipid Profile.( Total\n\n\ncholesterol,LDL,HDL,treigylcerides,Apo A1,Apo B,Lp(a) )', '595', '684'),
('1521', 'Apo A1.', '200', '230'),
('1522', 'Apo B.', '199', '229'),
('1523', 'Lp (a).', '445', '512'),
...
('1553', 'Serum Protein electrophoresis with\nimmunofixationelectrophoresis (IFE)', '300', '345'),
...
('1624', 'ERCP (Endoscopic Retrograde Cholangio ?\nPancreatography)', '2500', '2875'),
('1625', 'General :Fistulography\n/Sinography/Sialography/Dacrocystography/  T-Tube cholangiogram/Nephrostogram', '638', '750'),
...
('1653', 'C. T. Spine (Cervical, Dorsal, Lumbar, Sacral)?without\ncontrast', '1500', '1725'),
...
('1660', 'C. T. Guided intervention -percutaneous catheter drainage /\ntube placement', '1305', '1535'),
...
('1714', 'Dexa Scan Bone Densitometry - Three sites (Spine, Hip &\nextremity)', '2000', '2300'),
...
('1736', 'Basic studies including cell count, protein, sugar, gram stain,\nIndia Ink preparation and smear for AFP', '240', '276'),
...
('1745', 'Antibody titre (Herpes simplex, cytomegalo virus, flavivirus,\nzoster varicella virus)', '760', '874'),
...
CREATE TABLE `register` (
  `s_no` int(3) NOT NULL,
  `diaryNo` char(6) NOT NULL,
  `diaryType` char(10) NOT NULL,
  `diaryDate` text NOT NULL,
  `rank` varchar(25) NOT NULL,
  `applicantName` char(25) NOT NULL,
  `idNo` varchar(10) NOT NULL,
  `pis` char(10) NOT NULL,
  `treatment_by` char(50) NOT NULL,
  `hospitalName` varchar(100) NOT NULL,
  `type` varchar(20) NOT NULL,
  `amt_claimed` text NOT NULL,
  `admis_amt` text NOT NULL,
  `send_to` varchar(10) NOT NULL,
  `number` char(10) NOT NULL,
  `date` text NOT NULL,
  `sanction_no` varchar(10) NOT NULL,
...
INSERT INTO `register` (`s_no`, `diaryNo`, `diaryType`, `diaryDate`, `rank`, `applicantName`, `idNo`, `pis`, `treatment_by`, `hospitalName`, `type`, `amt_claimed`, `admis_amt`, `send_to`, `number`, `date`, `sanction_no`, `objection`, `timestamp`) VALUES
(9, '3544', 'Individual', '05/04/2017', 'Head Constable', 'Amit Tyagi', '22/SE', '27080056', 'Mother', 'Narang Eye Institute', 'Referral', '17159.00', '', '', '', '', '', 0, '2017-04-10 04:32:05'),
(10, '3281', 'Individual', '05/04/2017', 'Constable', 'Rajnish Kumar', '3594/SE', '28105180', 'Wife', 'Rungta Hospital Jaipur', 'Referral', '23490', '', '', '', '', '', 0, '2017-04-10 04:32:05'),
(11, '3286', 'Individual', '05/04/2017', 'Head Constable', 'Sarnam Singh', '1955/SE', '28040315', 'Mother', 'Bhagwan Mahavir Cancer Hospital and Research Center', 'Emergency', '149041.00', '', '', '', '', '', 0, '2017-04-10 04:32:05'),
(12, '3348', 'Individual', '06/04/2017', 'Assistant Sub-Inspector', 'ASI Mahender Pal Singh', '397/SE', '28910857', 'Self', 'Batra Hospital', 'Referral', '9915', '', '', '', '', '', 0, '2017-04-10 04:32:05'),
(13, '3349', 'Individual', '06/04/2017', 'Assistant Sub-Inspector', 'Anuj Kumar', '2307/SE', '28890325', 'Son', 'Cygnus Orthocare Hospital', 'Emergency', '60735.00', '', '', '', '', '', 0, '2017-04-10 04:32:05'),
(14, '3350', 'Individual', '06/04/2017', 'Constable', 'Satish', '1017/SE', '28080017', 'Daughter', 'RML Hospital', 'Referral', '', '', '', '', '', '', 0, '2017-04-10 04:32:05'),
(15, '3351', 'Individual', '06/04/2017', 'Constable', 'Lakhan Singh Meena', '3260/SE', '28121996', 'Wife', 'Riya Hospital', 'Emergency', '9904.00', '', '', '', '', '', 0, '2017-04-10 04:32:05'),
(16, '3352', 'Individual', '06/04/2017', 'Sub-Inspector', 'Om Parkash', 'D-3821', '28780191', 'Self', 'Visitech Eye Centre', 'Referral', '25438.00', '', '', '', '', '', 0, '2017-04-10 04:32:05'),
(17, '3354', 'Individual', '06/04/2017', 'Assistant Sub-Inspector', 'Bhikamber Sharma', '585/SE', '28940255', 'Mother', 'Apollo Hospital', 'Referral', '7549', '', ' ', '', ' ', ' ', 0, '2017-04-10 04:32:05'),
(18, '3355', 'Individual', '06/04/2017', 'Head Constable', 'Anand Singh', '118/SE', '28990780', 'Self', 'Safdarjung Hospital', 'Govt', '2300.00', '', '', '', '', '', 0, '2017-04-10 04:32:05'),
(19, '3369', 'Individual', '06/04/2017', 'Sub-Inspector', 'Naresh Babu', '273-D', '27890401', 'Self', 'Fortis escorts Hospital', 'Emergency', '', '', '', '', '', '', 0, '2017-04-10 04:32:05'),
(20, '3384', 'Individual', '06/04/2017', 'Assistant Sub-Inspector', 'Brijender', '827/SE', '28880451', 'Wife', 'CGHS Dispensary', 'Referral', '920.00', '', '', '', '', '', 0, '2017-04-10 04:32:05'),
(22, '3390', 'Individual', '06/04/2017', 'Constable', 'Sujeet Kumar', '3306/SE', '28093413', 'Son', 'Safdarjung Hospital', 'Govt', '1682.00', '', '', '', '', '', 0, '2017-04-10 04:32:05'),
(23, '2026', 'Individual', '05/04/2017', 'Constable', 'Hari Chand', '3569/SE', '29102324', 'Wife', 'Holy Family Hospital', 'Referral', '8729.00', '', ' ', '', ' ', ' ', 0, '2017-04-10 04:32:05'),
(24, '3279', 'Individual', '05/04/2017', 'MTS', 'Laxmi Devi', '697/C', '88030013', 'Self', 'CGHS Dispensary', 'Govt', '354.00', '', ' ', '', ' ', ' ', 1, '2017-04-10 04:32:05');
...
--
ALTER TABLE `form`
  MODIFY `app_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=185;
--
