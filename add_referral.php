...
VALUES (CURDATE(), '$appName', '$pis', '$rank', '$relation', '$startDate', '$hospitalName', '$hospitalAddress', '$policestationNo', '$diaryNo',$appCGHSno,'$appCGHSexp',$refCGHSno,'$refCGHSexp','$appCGHScategory', '$diaryDate','OP_REFERRAL', 'HAG')";
