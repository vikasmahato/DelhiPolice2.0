...
VALUES (CURDATE(), '$appName', '$pis', '$rank', '$relation','$relativeName','$startDate', '$endDate', '$hospitalName', '$hospitalAddress', '$policestationNo', '$diaryNo',$appCGHSno,'$appCGHSexp',$refCGHSno,'$refCGHSexp','$appCGHScategory', '$diaryDate','OP_EMERGENCY', 'HAG', '$disease')";
